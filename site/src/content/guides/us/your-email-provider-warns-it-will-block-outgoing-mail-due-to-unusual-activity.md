...
tags:
  ...
  - "email account takeover warning"
  - "smtp sending blocked"
  - "mailbox sending suspended"
  - "what do i do if outgoing mail is blocked"
  - "what do i do if email says unusual activity"
  - "what do i do if my email sent spam"
  - "what do i do if my mailbox is suspended"
  - "help i cannot send email"
  - "help i got an email security warning"
  - "help i think my email was hacked"
  - "help i got an outgoing mail block"
  - "my email is rate limited"
  - "my email sent messages without me"
  ...
  - "fake unblock email"
  - "email hacked or glitched"
  - "legitimate security alert confusion"
...
# What to do if… your email provider warns it will block outgoing mail due to unusual activity (USA)
...
## What to do now
1. **Pause outbound sending and open the provider safely.**  
...
2. **Use the provider’s official verify or unblock flow.**  
...
3. **Check recent activity and remove unknown sessions.**  
...
4. **Check for mailbox takeover settings.**  
   In mail settings, look for anything you did not create, especially:
...
5. **Remove unknown apps that can use or send from the account.**  
...
7. **Check the device you used for signs of compromise.**  
...
8. **Check sent, deleted, and archived mail.**  
...
9. **Warn contacts only after the account is under control.**  
...
10. **If this is a work or organization email, contact IT or security now.**  
   Ask them to check sign-in logs, outbound sending spikes, suspicious rules, and whether other accounts may be affected.

11. **If money or identity information may be at risk, use official reporting routes.**  
...
- https://support.microsoft.com/en-US/accounts-billing/manage/unblock-my-outlook-com-account
