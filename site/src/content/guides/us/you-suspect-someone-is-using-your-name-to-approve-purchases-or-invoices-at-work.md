...
tags:
  ...
  - "name used for purchases at work"
  - "name used on invoices at work"
  - "purchases approved in my name"
  - "invoices approved in my name"
  - "fake approval under my name"
  - "unauthorized invoice approval at work"
  - "unauthorized purchase approval at work"
  - "approval workflow used my name"
  - "vendor payment in my name"
  - "what do i do if someone used my name at work"
  - "what do i do if invoices show my name"
  - "what do i do if purchases were approved by me"
  - "what do i do if my work approval was misused"
  - "help i found invoices in my name"
  - "help i am blamed for approvals"
  - "my name is on work invoices"
  - "my approval was used at work"
  - "unexpected approval emails"
  - "strange invoice notifications"
  - "vendor bank details changed"
  - "payments pending under my name"
  - "audit log shows my name"
  - "unknown delegated approval access"
  - "business email compromise concern"
  - "procurement fraud concern"
  - "accounts payable fraud concern"
  - "invoice scam at work"
  - "approver impersonation at work"
  - "invoce approval in my name"
  - "aproval used without permission"
  - "remote work approval system"
  - "shared login workplace concern"
  - "finance team payment issue"
last_reviewed: "2026-06-24"
date_created: "2026-06-24"
---

# What to do if… you suspect someone is using your name to approve purchases or invoices at work (USA)
