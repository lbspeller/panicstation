...
tags:
  ...
  - lawn sprinklers won’t stop
  - irrigation keeps running
  - valve box flooding
  - sprinkler timer malfunction
  - manual bleed screw open
  - solenoid left on
  - irrigation main shutoff
  - sprinkler valve won’t close
...
## What to do now
1. **Make the area safer first.** Watch for slippery surfaces and spraying water near power (outlets, landscape lighting transformers, pump wiring). Keep kids/pets away from spray and puddles.
...
3. **Shut off water to the irrigation system (best option).**  
...
4. **If you can’t find the irrigation shutoff fast, shut off the home’s main water.**  
...
5. **If one zone is running and you can safely access the valve box, try the quick “manual ON” checks.**  
...
6. **If it still won’t stop, keep the water isolated and call the right help.**  
...
7. **After the water is off, document what you saw.** Take a quick photo of the controller screen/settings and the valve area before anything is changed (useful for a service call).
