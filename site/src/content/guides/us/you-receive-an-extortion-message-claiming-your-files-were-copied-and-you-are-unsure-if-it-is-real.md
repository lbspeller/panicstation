...
tags:
  - "extortion message claims copied files"
  - "blackmail message claims copied files"
  - "email says files were stolen"
  - "hacker claims files were copied"
  - "message threatens to leak files"
  - "cyber extortion message"
  - "bitcoin blackmail message"
  - "data theft threat email"
  - "ransom demand about files"
  - "fake breach extortion email"
  - "what do i do if files were copied"
  - "what do i do if i got blackmailed"
  - "what do i do if email says hacked"
  - "what do i do if hacker wants bitcoin"
  - "help i got an extortion email"
  - "help i got a blackmail message"
  - "help i think my files were stolen"
  - "help i clicked an extortion link"
  - "my files may be copied"
  - "my email says i was hacked"
  - "my password is in blackmail email"
  - "my data may be leaked"
  - "old password in extortion email"
  - "unknown login after blackmail email"
  - "strange file names in threat"
  - "crypto wallet in blackmail email"
  - "webcam claim in extortion email"
  - "urgent countdown payment demand"
  - "is this ransomware"
  - "is this sextortion"
  - "is this phishing"
...
# What to do if… you receive an extortion message claiming your files were copied and you are unsure if it is real (USA)
