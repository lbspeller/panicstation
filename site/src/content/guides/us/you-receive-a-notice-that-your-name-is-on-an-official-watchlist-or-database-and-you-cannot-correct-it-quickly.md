...
tags:
  - "name appears on watchlist"
  - "name appears on database"
  - "official watchlist notice"
  - "government database notice"
  - "watchlist name match"
  - "database name mismatch"
  - "flagged government record"
  - "mistaken watchlist identity"
  - "cannot correct watchlist quickly"
  - "cannot correct database quickly"
  - "what do i do if watchlisted"
  - "what do i do if flagged"
  - "what do i do if misidentified"
  - "what do i do if database wrong"
  - "help i am on watchlist"
  - "help i was flagged"
  - "help i cannot correct database"
  - "help i got watchlist notice"
  - "my name is flagged"
  - "my name is on watchlist"
  - "my record looks wrong"
  - "my database notice is wrong"
  - "repeated airport screening"
  - "border delay name match"
  - "secondary screening again"
  - "background check mismatch"
  - "official notice reference number"
  - "false positive name match"
  - "wrong person same name"
  - "watch list mistake"
  - "goverment database error"
  - "offical watchlist notice"
  - "travel screening problem"
...
# What to do if… you receive a notice that your name is on an official watchlist or database and you cannot correct it quickly (USA)
...
## What to do now
1. **Check whether the notice is real through an independent route.**
...
2. **Preserve the notice and make a short incident log.**
...
3. **If this is about repeated airport, airline, or border screening, use DHS TRIP.**
...
4. **If this is about a criminal-history or background-check record, get the official record before disputing it.**
...
5. **If this is about another federal agency record, ask for the agency’s Privacy Act route.**
...
6. **Ask for a narrow temporary mitigation while review is pending.**
...
7. **Slow down if the situation turns into questioning about conduct.**
...
- https://www.federalregister.gov/documents/2025/11/26/2025-21111/revision-of-agency-information-collection-activity-under-omb-review-department-of-homeland-security
