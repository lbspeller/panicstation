...
tags:
  ...
  - can't find deceased at morgue
  - hospital morgue vs funeral home
  - medical examiner case location
  - coroner case body location
  - told different locations after death
  - decedent affairs office contact
  - next of kin locating body
  - custody confirmation needed
  - release authorization confusion
  - waiting for autopsy release
  - transfer between facilities delay
  - funeral home can't pick up yet
  - county morgue holding check
  - death investigation hold
  - viewing arrangements unclear
  - case number missing
  - identification not yet confirmed
...
## What to do now
1. **Open a single running log.** Write down: full name, date of birth (if known), date/place of death, and for each call: time, number, person’s name/title, and exactly what they confirmed.
2. **Get the best available case identifier.** Ask whoever notified you for one of: police incident/report number, hospital MRN/account number, or Medical Examiner/Coroner case number.
3. **Call the two places that most commonly have custody and ask one exact question:** “Are they in your custody right now?”
...
4. **Ask two clarifying questions that reduce misdirection.**
...
5. **Ask exactly what they need from the legal next of kin to release the remains to the funeral home.**  
   Use this wording: “What authorization form or documentation do you need from the legal next of kin for release, and how can it be submitted (in person/email/fax/portal)?”
6. **Request one named point of contact.** Ask: “Who is the assigned investigator/family contact for updates, and what is the direct callback number?”
7. **If two agencies give different locations, ask about transfer status.**  
   Say: “I’m getting conflicting locations. Is the decedent pending transfer, and if so, from where to where, and who should confirm once received?”
8. **If you’ve selected a funeral home, have them coordinate (but with one clear request).**  
