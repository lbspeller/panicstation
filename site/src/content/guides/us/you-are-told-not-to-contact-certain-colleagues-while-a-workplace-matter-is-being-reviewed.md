...
tags:
  ...
  - "asked not to talk to coworkers"
  - "no contact instruction at work"
  - "coworker contact restricted at work"
  - "colleague contact restricted at work"
  - "not suspended but contact restricted"
  - "workplace review contact restriction"
  - "told not to contact collegues"
  - "coworker contact restriced at work"
  - "what do i do if coworker contact stops"
  - "what do i do if colleague contact stops"
  - "what do i do if hr restricts contact"
  - "what do i do if manager restricts contact"
  - "help i cannot contact my coworkers"
  - "help i cannot message my colleagues"
  - "help i was told avoid coworkers"
  - "my manager said no coworker contact"
  - "my workplace says avoid certain colleagues"
  - "my job contact channels are unclear"
  - "coworker names listed by hr"
  - "work messages suddenly restricted"
  - "work tasks need blocked coworkers"
  - "manager gave unclear contact rules"
  - "colleagues included in workplace review"
  - "not suspended but treated like suspended"
  - "workplace confidentiality instruction confusion"
  - "informal no contact order confusion"
  - "workplace investigation restriction confusion"
  - "manager instruction or suspension confusion"
  - "remote work coworker contact restricted"
  - "union workplace colleague contact restricted"
  - "private sector coworker contact restricted"
...
# What to do if… you are told not to contact certain colleagues while a workplace matter is being reviewed (USA)
## Short answer
