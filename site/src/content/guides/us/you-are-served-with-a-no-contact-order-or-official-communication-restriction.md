...
tags:
  - "communication restricted by order"
  - "official order no contact"
  - "notice not to contact"
  - "court order no contact"
  - "protective order no contact"
  - "restraining order notice"
  - "criminal protective order notice"
  - "probation no contact condition"
  - "supervised release contact restriction"
  - "prison communication restriction"
  - "jail contact restriction notice"
  - "what do i do if i cannot contact someone"
  - "what do i do if i got a no contact order"
  - "what do i do if someone has a protective order"
  - "what do i do if the order says no communication"
  - "help i was told not to text someone"
  - "help i got served with a restraining order"
  - "help i cannot message someone"
  - "help i received a court order"
  - "my communication is restricted"
  - "my probation says no contact"
  - "my release conditions ban contact"
  - "someone protected contacted me first"
  - "order says no third party contact"
  - "cannot reply to protected person"
  - "cannot call or text"
  - "cannot message on social media"
  - "confused what contact means"
  - "confused about indirect contact"
  - "confused about order permission"
  - "restaining order notice"
  - "no contac order notice"
  - "after being served papers"
...
# What to do if… you are served with a no-contact order or official communication restriction (USA)
...
## What to do now
1. **Pause all contact across every channel.**  
...
2. **Move the order somewhere you can read it without rushing.**  
...
3. **Save proof that you stopped contact.**  
...
4. **If the protected person contacts you first, do not respond.**  
...
5. **Use the right formal channel for clarification.**  
...
6. **If you are on probation, parole, pretrial release, or supervised release, contact your supervising officer if you have one.**  
...
7. **If there is an urgent practical issue, use only a clearly allowed route.**  
...
8. **If you are the protected person and you feel unsafe, prioritize immediate safety.**  
...
9. **If the notice relates to jail or prison communication, do not route around it.**  
