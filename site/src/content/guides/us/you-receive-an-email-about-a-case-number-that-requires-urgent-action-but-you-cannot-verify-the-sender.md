...
tags:
  ...
  - "unverified case number email"
  - "suspicious case number email"
  - "fake case number email"
  - "official looking case email"
  - "unexpected case number email"
  - "threatening case number email"
  - "unknown sender case email"
  - "what do i do if case number email"
  - "what do i do if fake court email"
  - "what do i do if sender cannot verify"
  - "what do i do if email demands payment"
  - "help i got case number email"
  - "help i clicked case email"
  - "help i opened legal attachment"
  - "help i cannot verify sender"
  - "my case number email looks fake"
  - "my legal email has a link"
  - "my email says urgent action"
  - "my sender address looks wrong"
  - "case number in subject line"
  - "sender address slightly wrong"
  - "email mentions warrant"
  - "email mentions summons"
  - "email has attachment"
  - "email has payment link"
  - "email has qr code"
  - "fake warrant email"
  - "fake summons email"
  - "spoofed court email"
...
# What to do if… you receive an email about a case number that requires urgent action but you cannot verify the sender (USA)
