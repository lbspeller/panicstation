...
tags:
  ...
  - "remains release delayed"
  - "body not yet released"
  - "waiting for body release"
  - "waiting for remains release"
  - "funeral planning before release"
  - "funeral delayed by body release"
  - "release date not confirmed"
  - "what do i do if body release is delayed"
  - "what do i do if remains are not released"
  - "what do i do if funeral planning must start now"
  - "what do i do if release date is uncertain"
  - "help i am waiting for body release"
  - "help i need to plan before release"
  - "my family is waiting for remains"
  - "my funeral plans are on hold"
  - "no confirmed release date"
  - "cause of death pending"
  - "autopsy results still pending"
  - "funeral home pickup pending"
  - "authorization not yet filed"
  - "overwhelmed by funeral admin"
  - "confusing body release with death certificate"
  - "confusing release with funeral approval"
  - "unsure who can authorize release"
  - "unsure who has custody of body"
  - "after sudden death body delayed"
  - "after hospital death body delayed"
  - "while cause of death is pending"
...
# What to do if… you are waiting for a body to be released and need to plan next steps (USA)
## Short answer
