...
tags:
  - "accused of time fraud at work"
  - "accused of time theft at work"
  - "accused of time fraud"
  - "accused without time fraud evidence"
  ...
  - "what do i do if timesheet questioned"
  - "what do i do if timecard questioned"
  - "what do i do if hours disputed"
  - "what do i do if manager accuses me"
  - "help i am accused of time fraud"
  - "help i am accused of time theft"
  - "my manager says i stole time"
  - "my timecard is being questioned"
  - "asked to explain time records"
  - "worried about a time fraud meeting"
  - "confused by timekeeping records"
  - "missing clock in record"
  - "unexpected timecard edit"
  - "timekeeping system error"
  - "schedule and timecard mismatch"
  - "remote work hours questioned"
  - "break time record dispute"
  - "overtime hours questioned"
  - "time theft allegation at work"
  - "timeshet falsification accusation"
  - "accused of time fruad at work"
...
# What to do if… you are accused of time fraud or timesheet discrepancies at work (USA)
...
## What to do now
1. **Ask for the allegation in writing.** Request the disputed dates and times, the policy they believe was violated, and the next step in the process.
2. **Ask what records are being considered.** Ask whether you can review the relevant timekeeping report, any edit history, schedules, approvals, and other records the employer is relying on. Do not assume every record must be disclosed.
3. **Preserve your own lawful records.** Keep copies of relevant records you already have permission to access, such as calendar entries, sent messages, shift approvals, pay stubs, or notes about a timeclock problem. Keep original timestamps where possible.
4. **Write a short timeline.** For each disputed date, note when you worked, any breaks, where you worked, the work completed, and any timekeeping issue. Separate what you know from anything you are unsure about.
5. **If you are union-represented, request representation before an investigatory interview that could lead to discipline.** If you reasonably believe the interview could lead to discipline, say: “I request union representation.” Do not waive that request impulsively.
6. **If pay may be affected, keep a separate hours-and-pay log.** For covered, nonexempt workers, federal rules generally require employers to maintain accurate hours-and-wages records. State rules may also matter.
7. **After a meeting, send a brief factual recap.** Record the allegation, the records you asked about, and the next step. Keep the tone neutral.
