...
tags:
  ...
  - "passport details requested for ticket"
  - "ticket reissue needs passport"
  - "passport not accessible right now"
  - "passport locked away during reissue"
  - "passport number requested for ticket"
  - "passport scan requested for reissue"
  - "airline asks for passport details"
  - "travel agent asks for passport"
  - "rebooking needs passport details"
  - "what do i do if passport unavailable"
  - "what do i do if airline asks passport"
  - "what do i do if ticket reissue needs passport"
  - "what do i do if passport locked away"
  - "help i cannot access passport"
  - "help i need passport details now"
  - "my passport is not accessible"
  - "my ticket reissue needs passport"
  - "my passport details are unavailable"
  - "my airline wants passport details"
  - "urgent passport details request"
  - "unexpected passport upload request"
  - "worried passport request is suspicious"
  - "passport request feels like phishing"
  - "passport request seems like identity theft"
  - "passport request confused with check-in"
  - "passport details confused with boarding pass"
  - "passport details confused with visa"
  - "international ticket reissue passport unavailable"
  - "traveling abroad passport unavailable"
...
# What to do if… you are asked for passport details to reissue a ticket and your passport is not accessible (USA)
## Short answer
...
## What to do now
1. **Verify who is asking through a route you choose.**  
...
2. **Ask which passport fields are actually required.**  
...
3. **Ask for the official submission route.**  
...
4. **Ask whether the deadline can be paused or noted.**  
...
5. **Check your own secure records without guessing.**  
...
6. **Stop if the request still seems suspicious.**  
