...
tags:
  ...
  - preneed contract lost
  - can't find funeral plan provider
  - funeral plan no paperwork
  - funeral trust unknown
  - funeral insurance policy unknown
  - final expense policy missing
  - funeral home preneed contract
  - prepaid burial plan missing
  - prepaid cremation plan missing
  - funeral plan payments found
  - locate preneed escrow
  - state funeral board preneed
  - state insurance department help
  - unclaimed property for deceased
  - naic policy locator
  - beneficiary can't find policy
  - bereavement admin urgent
last_reviewed: "2026-02-23"
---

# What to do if… you are told a prepaid funeral plan exists but no one can find the provider details (USA)
...
- https://content.naic.org/article/naic-life-insurance-policy-locator-tool-helps-consumers-connect-more-13-billion-benefits
