---
title: "What to do if… you notice your water meter is moving even though all taps and appliances are off"
jurisdiction: "USA"
category: "Home & property emergencies"
tags:
  - water meter moving
  - meter leak indicator spinning
...
# What to do if… you notice your water meter is moving even though all taps and appliances are off (USA)
...
## What to do now
1. **Scan for immediate damage risk.** Look for pooling water, wet drywall/ceilings, a toilet that keeps refilling, damp around the water heater, or soggy spots in the yard. Keep water away from outlets and power strips.
2. **Shut off water at the main house shutoff (best first step).** This is often where the pipe enters the house (basement, garage, utility closet). Turn it off fully.
...
3. **Re-check the water meter while the main house shutoff is OFF.**
...
4. **Document it clearly.** Take a photo/video of the meter (showing the moving indicator), note the time, then check again after **about an hour** with no water use. If you can manage a longer no-use window, it can help reveal very slow leaks.
5. **If it appears to be inside the home, check the usual “silent” culprits first:**
...
6. **Choose the safest “water on/off” plan for the next few hours.**
...
7. **Get the right help based on where the leak likely is.**
