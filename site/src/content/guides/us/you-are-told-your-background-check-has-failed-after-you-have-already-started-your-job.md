...
tags:
  - "background check failed after starting work"
  - "background check failed after onboarding"
  - "background screening failed after starting job"
  - "started work then background check failed"
  - "employment background check came back failed"
  - "background check problem after hire"
  - "background report error after starting work"
  - "background check mismatch after starting work"
  - "what do i do if background check failed"
  - "what do i do if hr says failed"
  - "what do i do if screening is wrong"
  - "what do i do if work check failed"
  - "help i started work then failed"
  - "help i think my report is wrong"
  - "my background check failed after hire"
  - "my background report has wrong records"
  - "wrong person on background report"
  - "criminal record mix-up at work"
  - "incorrect employment history on report"
  - "incorrect education history on report"
  - "identity mismatch in background check"
  - "expunged record still appearing"
  - "background check has wrong dates"
  - "background check failed but no reason"
  - "background check pending after onboarding"
  - "background check clearance issue"
  - "conditional offer confusion after starting"
  - "background check notice confusion"
  - "third-party background check at work"
  - "regulated job background check issue"
  - "licensed role background check issue"
...
# What to do if… you are told your background check has failed after you have already started your job (USA)
...
- https://files.consumerfinance.gov/f/documents/cfpb_background-screening-report_handout_2021-08.pdf
