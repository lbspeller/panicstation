...
tags:
  ...
  - "urgent debt collector deadline"
  - "collection agency court threat"
  - "court papers about debt"
  - "summons for debt lawsuit"
  - "complaint for debt lawsuit"
  - "served with debt lawsuit"
  - "what do i do if debt collector says lawsuit"
  - "what do i do if collector gives short deadline"
  - "what do i do if debt legal action starts"
  - "what do i do if debt summons arrives"
  - "help i got debt court papers"
  - "help i have a debt deadline"
  - "help i was served for debt"
  - "help i got a collection threat"
  - "my debt collector says court"
  - "my debt collector demands payment now"
  - "my debt lawsuit deadline is close"
  - "my debt summons just arrived"
  - "collector says pay immediately"
  - "collector claims case number"
  - "collector says final notice"
  - "debt not mine collections"
  - "wrong amount debt collection"
  - "unknown creditor debt demand"
  - "possible debt collection scam"
  - "debt collector pressure call"
  - "debt collector threatening message"
  - "debt collector voicemail deadline"
  - "debt colector threatening lawsuit"
...
# What to do if… a debt collector threatens legal action or gives you a short deadline (USA)
