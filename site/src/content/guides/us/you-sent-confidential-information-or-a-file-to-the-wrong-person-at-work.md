...
tags:
  - "sent confidential information wrong recipient"
  - "sent confidential info wrong person"
  - "confidential information sent by mistake"
  - "wrong recipient work email"
  - "wrong recipient confidential attachment"
  - "misdirected confidential email at work"
  - "accidental confidential disclosure at work"
  - "shared confidential work file wrong"
  - "sent client information wrong address"
  - "sent employee information wrong person"
  - "what do i do if i sent confidential information"
  - "what do i do if i emailed confidential data"
  - "what do i do if i sent a confidential attachment"
  - "what do i do if confidential work email wrong"
  - "help i sent confidential information"
  - "help i emailed the wrong person"
  - "my confidential email went wrong"
  - "my work file went to wrong recipient"
  - "email recall failed confidential information"
  - "external sharing link still active"
  - "wrong person opened confidential email"
  - "attachment sent outside company"
  - "sensitive spreadsheet sent wrong"
  - "personal information in wrong inbox"
  - "data breach or email mistake"
  - "confidentiality breach or accident"
  - "wrong cc or bcc mistake"
  - "data leak or misdirected email"
  - "confidental information wrong recipient"
  - "wrong recipent work email"
  - "at work confidential mistake"
  - "outside company wrong recipient"
last_reviewed: "2026-07-17"
date_created: "2026-06-19"
---

# What to do if… you sent confidential information or a file to the wrong person at work (USA)
...
## What to do now
1. **Pause and record the basic facts.** Write down what was sent, when it was sent, who received it, how it was sent, and whether it included personal information, credentials, health information, financial details, employee files, client information, or confidential business material.

2. **Try immediate containment if you have access to do it safely.**
...
3. **Report it immediately through your organization’s incident route.** Common routes include IT, security operations, the help desk, privacy, compliance, legal, or your manager. Use clear words such as: “Possible data breach or accidental disclosure: confidential information sent to wrong recipient.”

4. **Ask before contacting the recipient if your policy may control that contact.** If your policy allows it, or your incident contact tells you to, send a brief neutral request asking the recipient not to open, use, forward, copy, or save the information, and to delete it and confirm deletion in writing.

5. **If passwords, tokens, keys, account numbers, or access details were included, flag that as urgent.** Ask IT or security to decide whether to reset passwords, revoke tokens, disable links, rotate shared secrets, or check logs.

6. **Flag regulated or especially sensitive information without trying to decide the legal answer yourself.** Tell privacy, compliance, or legal if the information involved health information, Social Security numbers, financial account details, payroll or benefits files, customer records, employee records, attorney-client material, trade secrets, or contract-protected information.

7. **Keep a clean incident record.** Save the sent-message metadata, recipient address, subject line, attachment or link names, time sent, containment actions, report time, ticket number if there is one, and any deletion confirmation. Keep it factual and minimal.
