...
tags:
  - "joint account holder changed settings"
  - "joint account settings changed"
  - "joint bank account settings changed"
  - "joint checking account settings changed"
  - "co-owner changed account settings"
  - "account holder changed login details"
  - "shared account contact details changed"
  - "shared account security settings changed"
  - "what do i do if joint account changed"
  - "what do i do if account settings changed"
  - "what do i do if co-owner changed settings"
  - "what do i do if banking alerts stopped"
  - "help i lost joint account access"
  - "help i see unknown bank changes"
  - "help i found a new payee"
  - "help i cannot access online banking"
  - "my joint account settings changed"
  - "my co-owner changed bank details"
  - "my banking alerts were turned off"
  - "my joint account login stopped working"
  - "locked out of online banking"
  - "bank contact information changed"
  - "unknown payee on joint account"
  - "unexpected transfer limit change"
  - "unknown device on bank account"
  - "banking alerts unexpectedly disabled"
  - "account takeover or joint owner"
  - "joint owner or fraudster"
  - "joint account dispute or scam"
  - "shared account change without notice"
  - "joint acount holder changed settings"
  - "unkown account settings change"
...
# What to do if… a joint account holder changes your account settings without your knowledge (USA)
## Short answer
...
## What to do now
1. Contact the bank through a route you know is official. Use the bank’s official app or website, a recent statement, or the number on the back of your card. If someone may be monitoring your communications, use a private moment and a device you trust.

2. Tell the bank that you are a joint account holder and that major account settings changed without your knowledge. Ask the bank to note your concern, review recent activity, and explain what it can do immediately.

3. Ask what access protections and restoration options are available. These may include:
...
4. Ask the bank to review recent settings changes and tell you what it can confirm. Check for:
...
5. Report any transfer you did not make or authorize. Ask the bank how it will record the report. If the transfer may be an unauthorized electronic fund transfer or another Regulation E error, say that you want to report it as an error and provide the type, date, and amount if you can. A bank may require written confirmation within 10 business days after an oral notice of error; if it does, ask where to send it and send it promptly.

6. Secure the accounts that control your banking access using a device you trust:
...
8. If an incoming paycheck or benefit payment is due soon and you are worried it could be moved, ask your employer or paying agency whether a future payment can be redirected safely to an account in your name only. Ask about the timing before relying on the change.

9. If the bank does not resolve the problem or explain its response, submit a complaint to the Consumer Financial Protection Bureau.
...
- https://www.consumerfinance.gov/ask-cfpb/a-joint-checking-account-owner-took-all-the-money-out-and-then-closed-the-account-without-my-agreement-can-they-do-that-en-1099/
