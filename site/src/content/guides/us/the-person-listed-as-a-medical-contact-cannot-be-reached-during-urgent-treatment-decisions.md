...
tags:
  - "medical contact cannot be reached"
  - "listed medical contact is unreachable"
  - "emergency medical contact is not answering"
  - "medical contact phone number is outdated"
  - "health care proxy is unavailable"
  - "surrogate decision maker is missing"
  - "patient contact person is unavailable"
  - "hospital decisions are being discussed"
  - "treatment decisions are pending"
  - "serious medical decisions are pending"
  - "what do i do if contact unreachable"
  - "what do i do if proxy not answering"
  - "what do i do if surrogate unavailable"
  - "what do i do if hospital contact missing"
  - "help i cannot reach medical contact"
  - "help i cannot find health care proxy"
  - "my medical contact is not answering"
  - "my listed contact number is wrong"
  - "hospital calls are going unanswered"
  - "medical contact only has voicemail"
  - "listed contact phone is disconnected"
  - "alternate medical contact is not listed"
  - "advance directive is not in chart"
  - "proxy paperwork cannot be found"
  - "family contacts are giving different answers"
  - "next of kin is assumed decision maker"
  - "emergency contact is confused with proxy"
  - "medical contact is confused with surrogate"
  - "living will is confused with proxy"
  - "polst is confused with advance directive"
  - "medical contact unreachable during icu discussion"
  - "medical contact unreachable out of state"
...
# What to do if… the person listed as a medical contact cannot be reached during urgent treatment decisions (USA)
