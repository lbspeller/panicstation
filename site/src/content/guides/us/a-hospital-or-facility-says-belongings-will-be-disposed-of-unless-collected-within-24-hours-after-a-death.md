...
tags:
  ...
  - decedent belongings at hospital
  - collecting property after death
  - hospital holding valuables
  - decedent affairs office
  - patient relations escalation
  - nursing supervisor on duty
  - phone wallet keys missing
  - threatened disposal of property
  - next of kin release of items
  - personal representative not yet appointed
  - inventory of personal effects
  - property receipt form
  - security has valuables
  - risk management complaint
  - urgent belongings pickup
  - deceased patient personal effects
...
## What to do now
1. **Ask for the correct department immediately.** Use these exact requests:
...
2. **Request a disposal hold (one sentence).**  
   “I’m requesting an **immediate hold** on any disposal or release of property and a **written confirmation** that nothing will be discarded while we arrange pickup.”
3. **Ask for the written policy and who authorized the ‘24 hours.’**
   - “What policy requires this deadline? Please email/text me the policy or a written summary, and who authorized it.”
4. **Get a written inventory and chain-of-custody details.** Ask for:
...
5. **Clarify what documentation they require for release—and what happens if you don’t have it yet.**
...
6. **If you can’t get there quickly, propose a safe alternative immediately.**
...
7. **Escalate if anyone repeats “we’ll dispose of it.”**
...
8. **Document everything in a simple log.**
...
9. **If you believe property is missing (not just threatened), create an official paper trail today.**
