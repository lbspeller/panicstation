...
tags:
  ...
  - emergency transfer to another hospital
  - asked to consent to transfer
  - interfacility transfer questions
  - accepting hospital details
  - attending physician transfer plan
  - case manager transfer coordination
  - health care proxy document
  - medical power of attorney
  - advance directive hospital
  - hipaa personal representative
  - family access to information
  - transfer due to no ICU beds
  - specialist center transfer
  - urgent hospital decision
  - told to decide quickly
last_reviewed: "2026-03-03"
---

# What to do if… you are told a critically ill relative may be transferred to another hospital and you must respond quickly (USA)
