...
tags:
  ...
  - downspout leaking behind wall
  - water running behind downspout
  - gutter overflow near downspout
  - rainwater going behind gutter
  - downspout disconnect at outlet
  - water intrusion from gutter
  - rain leak into exterior wall
  - wall getting soaked during storm
  - interior leak only when raining
  - gutter blockage at one location
  - leaking gutter seam by downspout
  - downspout misaligned to outlet
  - water behind fascia board
  - sudden storm water leak
  - water damage from gutters
  - prevent mold after water leak
last_reviewed: "2026-03-04"
---

# What to do if… water is pouring over a gutter edge in one spot and running behind the downspout into the wall (USA)
## Short answer
...
## What to do now
1. **Prioritize electrical safety (first minute).**  
...
2. **Limit indoor damage immediately.**  
   Move valuables away from the wet wall/floor. Put down towels. Set a bucket/tray under drips. If water is tracking down a wall, a plastic sheet can help route it into a container.
3. **Do a quick ground-level exterior check (no ladder).**  
   Look for a visible cause:  
   - The downspout **not seated** under the gutter outlet (a gap that lets water run behind).  
...
4. **Only do a safe, minimal intervention.**  
   If a downspout joint is visibly slipped apart at ground level and clearly fits back together, reseat it gently. Don’t force anything, and don’t do anything that requires a ladder or puts you under falling water.
5. **Call the right help and use the right words.**  
...
6. **Start drying as soon as it’s safe (to reduce mold risk).**  
   Once water entry is stopped or clearly slowing and power is safe, ventilate and begin drying. **Ideally start within 24–48 hours** to reduce mold growth risk, but don’t rush if electricity safety is uncertain.
7. **Document for insurance and repairs.**  
