...
tags:
  ...
  - "utility account holder died"
  - "essential services after death"
  - "shutoff notice after death"
  - "electric bill after death"
  - "gas bill after death"
  - "water bill after death"
  - "sewer bill after death"
  - "deceased utility account"
  - "dead persons utility bill"
  - "what do i do if utilities are in deceased name"
  - "what do i do if power bill is deceased"
  - "what do i do if shutoff notice is coming"
  - "what do i do if account holder died"
  - "help i got a shutoff notice"
  - "help i cannot transfer utilities"
  - "help i found old utility bills"
  - "help i need power kept on"
  - "my utility bill is in a dead name"
  - "my electric account holder died"
  - "my water service may be shut off"
  - "my gas service is past due"
  - "shutoff date on notice"
  - "past due utility balance"
  - "mail addressed to deceased"
  - "autopay stopped after death"
  - "meter reading after death"
  - "service still in deceased name"
  - "estate bill confusion"
  - "probate utility confusion"
  - "executor utility confusion"
  - "survivor debt confusion"
  - "occupied home after death"
...
# What to do if… essential services are in the name of a person who died and shutoff notices may be coming (USA)
