...
tags:
  ...
  - "employer health plan terminated"
  - "insurance coverage stopped without warning"
  - "dependents dropped from health coverage"
  - "health benefits missing unexpectedly"
  - "coverage lapsed after payroll error"
  - "what do i do if health coverage cancelled"
  - "what do i do if benefits cancelled"
  - "what do i do if employer insurance ended"
  - "what do i do if dependents lost coverage"
  - "help i lost health coverage"
  - "help i was dropped from insurance"
  - "my benefits were cancelled unexpectedly"
  - "my health coverage ended suddenly"
  - "benefits portal shows terminated"
  - "insurer says member inactive"
  - "pharmacy says coverage inactive"
  - "medical claim says no coverage"
  - "payroll deductions still taken"
  - "dependent coverage disappeared"
  - "coverage ended during treatment"
  - "cobra notice not received"
  - "insurance canceled by mistake"
  - "benefits removed by payroll"
  - "employer premium payment missing"
  - "coverage termination date unclear"
  - "coverage cancelled during job change"
  - "health coverage cancelled mid-treatment"
  - "family coverage cancelled unexpectedly"
  - "job-based benefits cancelled after leave"
  - "health coverge cancelled unexpectedly"
...
# What to do if… your employer or provider tells you your benefits or health coverage have been cancelled unexpectedly (USA)
...
- https://www.healthcare.gov/how-can-i-get-consumer-help-if-i-have-insurance/
