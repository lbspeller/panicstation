...
tags:
  ...
  - "wrong information in hr file"
  - "incorrect personnel file entry"
  - "hr record has mistakes"
  - "personnel file has lies"
  - "false disciplinary record"
  - "inaccurate performance note"
  - "wrong write-up in file"
  - "background report has wrong information"
  - "what do i do if file is false"
  - "what do i do if hr is wrong"
  - "what do i do if record is wrong"
  - "what do i do if personnel file lies"
  - "help i found false hr information"
  - "help i found false personnel file"
  - "help i found wrong work record"
  - "help i found incorrect employee file"
  - "my hr record is wrong"
  - "my personnel file has lies"
  - "hr note says something false"
  - "personnel record shows wrong facts"
  - "file says i was disciplined"
  - "record shows false allegation"
  - "write-up is in my file"
  - "hr says i did something"
  - "background check is inaccurate"
  - "employment record has wrong reason"
...
# What to do if… you discover false or inaccurate information in your personnel file or HR record (USA)
...
3. **Ask to add your rebuttal to the same record.**  
   If HR will not remove or correct the original entry, ask that:
   - your written rebuttal be attached to the same entry or document
...
4. **Request access to your personnel file using the right route for your workplace and state.**  
...
5. **If a decision is pending, ask for a pause on relying on the disputed item.**  
...
6. **If the false information came from a third-party background check, use the FCRA dispute path.**  
   If an employer used a background screening company:
   - ask HR for the name of the screening company and the report used
...
7. **If you are represented, use your representative now.**  
