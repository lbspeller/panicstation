...
tags:
  - "notice from prosecutor"
  - "case referred to prosecutor"
  - "case sent to prosecutor"
  - "prosecutor asking for response"
  - "prosecutor wants statement"
  - "prosecutor wants interview"
  - "prosecutor letter received"
  - "charging review notice"
  - "pre-charge prosecutor notice"
  - "criminal case notice"
  - "what do i do if prosecutor contacts me"
  - "what do i do if case referred"
  - "what do i do if prosecutor asks"
  - "what do i do if police referred case"
  - "help i got prosecutor notice"
  - "help i need respond prosecutor"
  - "help i received charging notice"
  - "my case went to prosecutor"
  - "my case is under review"
  - "my prosecutor notice has deadline"
  - "asked to explain allegation"
  - "asked for written statement"
  - "asked for interview response"
  - "deadline to respond to prosecutor"
  - "subpoena or summons confusion"
  - "miranda warning confusion"
  - "right to silence confusion"
  - "prosecuter notice received"
  - "supeona with prosecutor notice"
  - "notice with court date"
  - "email from prosecutor office"
...
# What to do if… you receive a notice from a prosecutor asking for a response or statement (USA)
...
2. **Verify that the notice is genuine without discussing the allegation.**  
...
3. **Write down exactly what is being requested.**  
...
4. **Contact a criminal defense lawyer before giving any response about the facts.**  
...
5. **Use a narrow holding response only if a response is needed before you have counsel.**  
...
6. **If police, investigators, or a prosecutor try to question you, stop the conversation.**  
...
7. **Preserve records for your lawyer.**  
...
8. **Make a private timeline for legal counsel.**  
