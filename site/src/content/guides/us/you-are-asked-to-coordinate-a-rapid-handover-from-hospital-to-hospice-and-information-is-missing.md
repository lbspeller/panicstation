...
tags:
  - rapid hospital to hospice handoff
  ...
  - polst form missing
  - code status unclear
  - hospice election confusion
  - hospice intake today
  - end of life transition
  - caregiver coordinating discharge
  - after hours plan missing
  - hospice meds not arranged
  - dme not delivered
...
# What to do if… you are asked to coordinate a rapid handover from hospital to hospice and information is missing (USA)
...
## What to do now
1. **Ask for the hospital discharge lead and hospice liaison—by role, not name.**
...
2. **Request the “minimum safe handoff set” before the patient leaves.**
   Ask for these items in writing (print or secure electronic):
...
3. **Do a “meds tonight” check with both sides on speakerphone (if possible).**
   With the hospital nurse/pharmacist and hospice intake nurse:
...
4. **Confirm the hospice enrollment paperwork needed to start care today.**
...
5. **Confirm Durable Medical Equipment (DME) and transport are actually scheduled.**
...
6. **Request key records immediately, and ask the fastest route for anything else.**
...
7. **Escalate if you’re being pushed to transfer without safety basics.**
