...
tags:
  ...
  - "merchant demands immediate payment"
  - "merchant says pay immediately"
  - "large merchant charge"
  - "large charge sent to collections"
  - "disputed merchant charge"
  - "unexpected merchant bill"
  - "collections threat over charge"
  - "what do i do if merchant threatens collections"
  - "what do i do if merchant demands payment"
  - "what do i do if charge goes to collections"
  - "what do i do if bill goes to collections"
  - "help i got a collections threat"
  - "help i have a large charge"
  - "help i was told pay immediately"
  - "help i do not recognize this merchant charge"
  - "my merchant charge is disputed"
  - "my merchant bill may go to collections"
  - "caller demands payment today"
  - "message threatens credit damage"
  - "merchant refuses written details"
  - "merchant uses urgent deadline"
  - "charge amount looks wrong"
  - "account balance is unfamiliar"
  - "collection notice might be scam"
  - "merchant or debt collector confusion"
  - "billing error or debt"
  - "chargeback confusion after merchant charge"
  - "merchant threat might be final notice"
  - "large charge from merchant"
  - "merchant call about collections"
  - "merchant email about collections"
  - "third-party collector contact"
...
# What to do if… a merchant threatens to send a charge to collections unless you pay immediately (USA)
...
3. **Verify the charge through a contact route you find yourself.**  
...
4. **If a debt collector contacted you, ask for validation information.**  
...
5. **If you do not recognize the debt or disagree with the amount, send a written dispute promptly.**  
...
6. **If the charge appears on a credit-card statement, contact the card issuer.**  
...
7. **Secure any information you already shared.**  
