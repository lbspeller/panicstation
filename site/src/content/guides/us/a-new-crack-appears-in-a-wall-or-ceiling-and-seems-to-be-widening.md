...
tags:
  ...
  - crack after earthquake
  - diagonal crack near door
  - crack around window frame
  - crack with sagging ceiling
  - crack with sticking doors
  - possible foundation movement
  - possible structural damage
  - unsafe building concern
  - rental property crack emergency
...
## What to do now
1. **Decide if you need to leave immediately. Call 911 if any of these are true:**
...
2. **Create a “no-go zone.”** Keep people and pets out of the room. If it’s a ceiling crack, don’t stand or sleep underneath it.
3. **Rule out urgent utility hazards (quickly, only if safe).**
...
4. **Document what you’re seeing (helps with professionals and insurance).**
...
6. **Get an urgent inspection and notify the right authority if it may be unsafe.**
...
7. **Use a local reporting route if you need to flag an unsafe building condition.**
