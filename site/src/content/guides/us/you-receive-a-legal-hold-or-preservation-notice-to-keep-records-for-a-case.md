...
tags:
  ...
  - "preservation notice"
  - "notice not to destroy records"
  - "notice not to destroy messages"
  - "notice not to destroy photos"
  ...
  - "what do i do if preservation notice"
  - "what do i do if records matter"
  - "what do i do if photos matter"
  - "help i got a legal hold notice"
  - "help i deleted messages"
  - "help i changed my phone"
  - "help i lost old records"
  - "my phone has disappearing messages"
  - "my records might be relevant"
  - "my photos might be evidence"
  - "my messages are auto-deleting"
  - "auto-delete messages turned on"
  - "disappearing messages turned on"
  - "texts already deleted"
  - "photos backed up in cloud"
  - "old phone has case records"
  - "not sure what records mean"
  - "not sure what relevant means"
  - "is this a subpoena"
  - "is this a preservation letter"
  - "work email legal hold"
  - "social media messages case"
  - "shared device messages case"
  - "recieve preservation notice"
  - "distroy records notice"
last_reviewed: "2026-06-21"
date_created: "2026-06-21"
---

# What to do if… you receive a legal hold or preservation notice to keep records for a case (USA)
...
- https://www.thesedonaconference.org/publication/Commentary_on_Legal_Holds
- https://www.uscourts.gov/file/elementsofapreservationrulepdf
