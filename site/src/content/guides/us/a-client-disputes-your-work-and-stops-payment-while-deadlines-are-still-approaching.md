...
tags:
  ...
  - "client stops payment"
  - "client refusing to pay"
  - "payment stopped mid-project"
  - "completed work disputed"
  - "invoice unpaid after delivery"
  - "client withholding payment"
  - "deadline approaching during payment dispute"
  - "what do i do if client stops payment"
  - "what do i do if client disputes work"
  - "what do i do if invoice is unpaid"
  - "what do i do if deadline is approaching"
  - "help i am not being paid"
  - "help i have a client dispute"
  - "help i delivered work without payment"
  - "help i have an unpaid invoice"
  - "my client stopped payment"
  - "my completed work is disputed"
  - "my deadline is still approaching"
  - "my client claims work is incomplete"
  - "written approval ignored"
  - "scope dispute after delivery"
  - "client demands extra revisions"
  - "client disputes all amounts"
  - "client delays sign-off"
  - "platform payment dispute opened"
  - "chargeback after completed work"
  - "scope creep or payment dispute"
  - "unpaid invoice or wage issue"
  - "client dispute or contract breach"
  - "retainer dispute after delivery"
  - "freelance client payment dispute"
  - "contractor deadline payment dispute"
...
# What to do if… a client disputes your work and stops payment while deadlines are still approaching (USA)
