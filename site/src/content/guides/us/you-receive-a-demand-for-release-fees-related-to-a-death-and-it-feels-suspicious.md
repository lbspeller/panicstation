...
# What to do if… you receive a demand for “release fees” related to a death and it feels suspicious (USA)
...
## What to do now
1. **Pause and treat it as unverified.** Give yourself a short reset (slow exhale, unclench jaw). The safest first move is to slow the timeline down.
2. **Save evidence without engaging.** Screenshot texts, save emails/voicemails, and write down date/time and what they asked for. If there’s a link, copy it into a notes app (don’t open it).
3. **Verify through a trusted channel (not theirs).**
...
4. **If you already paid or shared details, contact the payment provider immediately.**
...
5. **If you shared SSN or ID details, start identity-recovery steps.**
...
7. **If you’re being threatened or pressured in real time, get help.**
