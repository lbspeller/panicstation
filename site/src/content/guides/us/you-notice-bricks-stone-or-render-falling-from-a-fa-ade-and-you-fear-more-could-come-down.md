...
tags:
  ...
  - stucco falling off wall
  - plaster falling from exterior wall
  ...
  - pieces falling near entrance
  - falling materials from height
  - facade shedding material
  - building exterior looks unsafe
  - worried more will fall
  - sidewalk hazard falling debris
  - outside wall breaking away
  - unstable building suspected
last_reviewed: "2026-03-04"
---

# What to do if… you notice bricks, stone, or render falling from a façade and you fear more could come down (USA)
## Short answer
...
## What to do now
1. **Move out of the drop zone immediately.** Go across the street if possible, or well beyond where debris could land. Avoid being directly below any part of the exterior wall.
2. **Warn others and prevent pass-through.** Calmly tell people nearby to move back. If you can do it safely, ask a nearby business/building to keep people away from the entrance under the affected area.
3. **Call for emergency help if there’s any immediate hazard.**
...
4. **If it’s not an immediate 911 situation, report it to local authorities.**
...
5. **Provide precise details.** Give the exact address, which side of the building, what material is falling (brick/stone/**stucco or plaster** — sometimes called “render”), whether it’s ongoing, and whether the sidewalk/road is affected.
6. **If you live/work there, reduce exposure without approaching the façade.**
...
7. **Notify the responsible party (after safety is addressed).** If it’s an apartment/condo, contact building management/HOA. If you rent, contact the landlord/property manager. If it’s a business, notify the manager on duty.
8. **Document from a safe distance.** If safe, take a photo/video from well back, and note the time and where debris landed. This can help emergency responders or inspectors act quickly.
