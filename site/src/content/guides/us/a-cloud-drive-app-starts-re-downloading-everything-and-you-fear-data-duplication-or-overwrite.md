...
tags:
  - "cloud drive app re-downloading everything"
  - "cloud drive mass redownload"
  - "cloud sync restarting unexpectedly"
  - "cloud storage downloading files again"
  - "cloud drive duplicate files"
  - "cloud drive overwrite fear"
  - "cloud drive resync loop"
  - "cloud drive files reappearing"
  - "what do i do if drive redownloads"
  - "what do i do if sync restarts"
  - "what do i do if duplicates appear"
  - "what do i do if files overwrite"
  - "help i see cloud drive duplicates"
  - "help i see files downloading again"
  - "my cloud drive is redownloading everything"
  - "my cloud files may be overwritten"
  - "conflicted copy files appearing"
  - "duplicate folders appearing"
  - "sync status shows mass download"
  - "cloud storage filling local disk"
  - "files reappearing after deletion"
  - "unexpected upload activity"
  - "wrong cloud account syncing"
  - "cloud backup restoring unexpectedly"
  - "cloud drive cache reset unexpectedly"
  - "cloud drive may be hacked"
  - "cloud drive duplicate backup"
  - "cloud sync loop"
  - "work cloud drive redownloading"
  - "school cloud drive redownloading"
  - "shared cloud drive duplicates"
  - "onedrive redownloading everything"
  - "google drive redownloading everything"
...
## What to do now
1. **Pause the desktop sync app if that option is available.**
...
2. **Copy the most important locally available files to a safe location.**
...
3. **Check the cloud website while the desktop app remains paused or closed.**
...
4. **Record what you are seeing before you clean anything up.**
...
5. **Use your organization’s support route first for a managed account.**
...
6. **Use the provider’s official account-security route if you see signs of unfamiliar access.**
