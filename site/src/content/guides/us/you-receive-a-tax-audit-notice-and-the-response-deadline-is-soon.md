...
tags:
  ...
  - "tax audit notice deadline"
  - "irs audit deadline soon"
  - "tax authority audit notice"
  - "audit response deadline"
  - "examination letter deadline"
  - "correspondence audit notice"
  - "field audit notice"
  - "office audit notice"
  - "what do i do if audit deadline"
  - "what do i do if irs audit"
  - "what do i do if tax audit"
  - "what do i do if examination letter"
  - "help i got an audit notice"
  - "help i missed audit mail"
  - "help i have an irs deadline"
  - "help i received audit letter"
  - "my audit response is due"
  - "my irs audit deadline is soon"
  - "my tax audit letter is urgent"
  - "deadline on audit letter"
  - "letter asks for tax records"
  - "notice asks for documents"
  - "audit letter by mail"
  - "tax year being questioned"
  - "proposed tax changes"
  - "fake irs audit letter"
  - "tax scam audit notice"
  - "audit letter or bill"
  - "notice of deficiency confusion"
  - "irs auddit notice"
  - "tax autority audit notice"
last_reviewed: "2026-07-17"
date_created: "2026-06-22"
---

# What to do if… you receive a tax audit notice and the response deadline is soon (USA)
