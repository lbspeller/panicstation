...
tags:
  - "custody property call"
  - "call about custody property"
  - "call saying store property"
  - "asked to store custody property"
  - "asked to pick up property"
  - "unsure about custody call"
  - "jail property call"
  - "prison property call"
  - "inmate property call"
  - "detained person property call"
  - "what do i do if custody calls"
  - "what do i do if jail calls"
  - "what do i do if prison calls"
  - "what do i do if property release call"
  - "help i got a jail call"
  - "help i feel unsure about property"
  - "my family member is in custody"
  - "my friend asked me to store property"
  - "caller demands fast answer"
  - "caller asks for gift cards"
  - "caller asks for bank details"
  - "caller id looks official"
  - "stranger offers property handoff"
  - "unknown bag or package"
  - "fake correctional officer call"
  - "law enforcement impersonation call"
  - "jail property release scam"
  - "property releese call"
  - "custody propertie call"
  - "custody property call in usa"
...
# What to do if… you receive a call asking you to store property for someone in custody (USA)
...
- https://www.bop.gov/news/20250409-phone-scams-impacting-incarcerated-individuals.jsp
