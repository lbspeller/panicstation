...
tags:
  - funeral home needs one signer
  - multiple relatives conflicting instructions
  - right of disposition dispute
  - who can authorize cremation
  - next of kin disagreement
  - designated agent after death
  - family conflict funeral arrangements
  - one point of contact required
  - siblings arguing about cremation
  - spouse and children disagree
  - funeral home won’t proceed
  - authorizing agent form
  - control of disposition priority
  - equal priority relatives disagree
  - stop relatives calling funeral home
  - burial arrangements conflict
  - hold arrangements pending authority
  - written authorization needed
  - bereavement conflict escalation
last_reviewed: "2026-03-03"
---

# What to do if… a venue requires one decision-maker for a service but multiple relatives are issuing instructions (USA)
...
## What to do now
1. **Ask the venue exactly how they determine the one decision-maker in your state.**  
...
2. **Check for a state-recognized written designation or pre-need file first.**  
   Practical places to check immediately:
   - a pre-need funeral contract (the venue may already have this)
...
3. **If there’s no designation, identify who is highest priority under your state’s right-of-disposition law.**  
...
4. **Send a single-point-of-contact email to the venue immediately.**  
   Include:
   - deceased’s full name, date of death, and the case/reference number
...
5. **Stop the cross-fire with one boundary message to relatives.**  
...
6. **Ask what can be held without committing while authority is clarified.**  
...
7. **If equal-priority relatives are deadlocked, use the venue’s stated path for your state — and get it in writing.**  
...
8. **If you need an outside authority fast, contact a state-level consumer/licensing office.**  
   Two practical options:
   - your **state funeral board/licensing agency** (they can often explain what documentation providers typically require)
...
- https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=HSC&sectionNum=7100.