...
tags:
  - "detention facility rejected mail"
  - "detention facility rejected funds"
  - "custody mail rejection notice"
  - "custody funds rejection notice"
  - "jail mail rejected"
  - "prison mail rejected"
  - "inmate funds rejected"
  - "commissary deposit rejected"
  - "what do i do if jail mail was rejected"
  - "what do i do if prison mail was rejected"
  - "what do i do if inmate funds were rejected"
  - "what do i do if a detention facility wants action"
  - "help i got a custody rejection notice"
  - "help i cannot send inmate funds"
  - "help i received a rejected mail message"
  - "help i do not know if the facility message is real"
  - "my letter to someone in custody was rejected"
  - "my commissary deposit was rejected"
  - "my detention facility payment was returned"
  - "my inmate mail was returned"
  - "mail returned to sender"
  - "deposit returned or missing"
  - "custody location may have changed"
  - "inmate identifier may be wrong"
  - "rejection reason is unclear"
  - "facility message asks for payment"
  - "mailroom rejected correspondence"
  - "trust account deposit problem"
  - "possible inmate funds scam"
  - "possible detention facility scam"
  - "federal custody mail rejected"
  - "state prison funds rejected"
  - "detension facility rejected mail"
  - "commisary deposit rejected"
last_reviewed: "2026-05-30"
date_created: "2026-05-30"
---

# What to do if… mail or funds you sent to someone in custody were rejected (USA)
...
- https://www.bop.gov/inmates/mobile_moneyInfo.jsp?method=wu
- https://www.ecfr.gov/current/title-28/chapter-V/subchapter-C/part-540/subpart-B
