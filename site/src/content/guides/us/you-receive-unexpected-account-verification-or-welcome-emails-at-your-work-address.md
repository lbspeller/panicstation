...
tags:
  - "work email used for unknown accounts"
  - "work email address used elsewhere"
  - "unknown accounts tied to work email"
  - "unrecognized accounts using work email"
  - "unexpected work email signup messages"
  - "work email account verification messages"
  - "work email password reset messages"
  - "work email possible compromise"
  - "what do i do if work email used"
  - "what do i do if unknown accounts appear"
  - "what do i do if work address reused"
  - "what do i do if signup emails arrive"
  - "help i got unknown account emails"
  - "help i see work email signups"
  - "help i received password reset emails"
  - "help i got work email alerts"
  - "my work email has unknown accounts"
  - "my work address is being reused"
  - "my work email has signup messages"
  - "my work email may be compromised"
  - "unexpected welcome emails at work"
  - "unrequested verification emails at work"
  - "unrequested password reset emails"
  - "unknown sign-in alert at work"
  - "inbox rules changed unexpectedly"
  - "email forwarding changed unexpectedly"
  - "unknown connected app on work email"
  - "spoofed work email address"
  - "mistyped work email address"
  - "spam signup emails at work"
...
# What to do if… you receive unexpected account verification or welcome emails at your work address (USA)
...
## What to do now
1. **Report the messages through your employer’s official channel.**  
...
2. **Use your employer’s approved reporting method.**  
...
3. **Tell IT or security about any other signs you have noticed.**  
...
4. **Secure the work account through your employer’s process.**  
...
5. **Make a brief list of the unknown services if it is easy to do.**  
...
6. **Escalate internally if impersonation or company-data exposure may be involved.**  
...
7. **Use the official identity-theft route if personal identity misuse may also be involved.**  
