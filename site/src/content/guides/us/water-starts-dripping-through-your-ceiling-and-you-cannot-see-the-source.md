...
tags:
  ...
  - ceiling leak can’t find source
  - water stain spreading on ceiling
  - ceiling sagging from water
  - ceiling bulge holding water
  - water dripping from ceiling light
  - water leaking through smoke detector
  - leak from upstairs neighbor
  - apartment ceiling leak emergency
  - condo ceiling leak upstairs unit
  - hidden pipe leak above ceiling
  - roof leak showing on ceiling
  - ceiling drip after rain
  - water intrusion inside ceiling
  - water leaking into electrical wiring
  - sudden indoor water leak
  - water dripping at night ceiling
  - mystery leak in apartment ceiling
...
## What to do now
1. **Clear the area and create distance.**  
...
2. **Shut off electricity (only if safe).**  
...
3. **Contain the drip to limit damage.**  
...
4. **Shut off water at the main shutoff valve (if you can).**  
...
5. **Escalate immediately in multi-unit buildings.**  
...
6. **Call the right level of help for safety.**  
...
7. **Document quickly, then keep it stable.**  
