...
tags:
  ...
  - "immigration fee demand"
  - "fake embassy message"
  - "fake consulate email"
  - "government imposter scam"
  - "fake immigration payment"
  - "suspicious visa payment link"
  - "what do i do if visa fee message"
  - "what do i do if permit fee message"
  - "what do i do if immigration payment"
  - "what do i do if embassy text"
  - "help i got a visa fee text"
  - "help i clicked visa payment link"
  - "help i paid immigration scammer"
  - "help i shared passport details"
  - "my visa is being held"
  - "my permit has a release fee"
  - "my passport details were requested"
  - "my immigration case says pay now"
  - "urgent deadline in visa message"
  - "threatening immigration email"
  - "payment by gift card request"
  - "payment by wire transfer request"
  - "payment by crypto request"
  - "qr code visa payment"
  - "visa lottery fee scam"
  - "dv program scam email"
...
# What to do if… you receive a message demanding an urgent fee to release a visa or permit (USA)
