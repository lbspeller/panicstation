...
tags:
  - "official no contact notice"
  - "no contact order with children"
  - "protective order with childcare"
  - "restraining order childcare conflict"
  - "court no contact childcare"
  - "criminal no contact condition"
  - "bond no contact condition"
  - "co-parenting no contact order"
  - "child exchange no contact"
  - "shared childcare no contact"
  - "what do i do if no contact order"
  - "what do i do if restraining order"
  - "what do i do if childcare conflict"
  - "what do i do if child exchange"
  - "help i cannot contact co-parent"
  - "help i got no contact notice"
  - "help i share childcare duties"
  - "help i risk accidental violation"
  - "my co-parent has no contact"
  - "my custody plan conflicts"
  - "must not text other parent"
  - "school pickup order conflict"
  - "medical updates no contact"
  - "child medication handoff problem"
  - "protected location at school"
  - "third-party contact confusion"
  - "indirect contact confusion"
  - "parenting plan conflict"
  - "supervised exchange confusion"
  - "restraning order childcare"
  - "no contact notic childcare"
  - "shared custody no contact"
...
# What to do if… you receive a no-contact order but share childcare or other responsibilities (USA)
...
## What to do now
1. **Get the full written order or condition.**  
...
3. **Identify what kind of notice it is.**  
   Treat it as strict no contact until clarified. Common sources include:
   - a civil protection order or restraining order
...
4. **Pause any exchange plan that would put you near the person or a protected location.**  
...
5. **Use only a no-contact childcare handoff that the order allows.**  
   Depending on the wording, lawful options may include:
   - a neutral adult doing the physical exchange, without carrying messages between adults
...
6. **Keep child items separate from adult messages.**  
...
7. **Do not use the school, daycare, doctor, or activity provider as a workaround unless it is clearly allowed.**  
...
8. **Ask for written clarification or modification quickly.**  
   Ask for a clear method for child exchanges and essential child-related information, such as a named exchange person, a supervised exchange provider, attorney-only contact, or a limited written channel. Use:
...
9. **Use emergency services for immediate child danger.**  
...
10. **Keep a factual compliance record.**  
...
- https://www.womenslaw.org/laws/general/custody/getting-custody-your-restraining-order/can-i-get-temporary-custody-part
...
- https://vera-institute.files.svdcdn.com/production/downloads/publications/supervised-visitation-safe-exchange-guide-report.pdf
