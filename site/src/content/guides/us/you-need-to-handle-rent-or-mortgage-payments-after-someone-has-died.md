...
tags:
  ...
  - "deceased tenant rent"
  - "deceased borrower mortgage"
  - "landlord after death"
  - "mortgage servicer after death"
  - "estate housing bill"
  - "probate rent due"
  - "probate mortgage due"
  - "what do i do if rent due"
  - "what do i do if mortgage due"
  - "what do i do if landlord calls"
  - "what do i do if servicer calls"
  - "help i owe rent after death"
  - "help i owe mortgage after death"
  - "my parent died rent due"
  - "my spouse died mortgage due"
  - "my relative died mortgage due"
  - "rent notice after death"
  - "mortgage notice after death"
  - "empty home after death"
  - "autopay after death"
  - "foreclosure notice after death"
  - "eviction notice after death"
  - "confused about executor"
  - "confused about estate bills"
  - "confused about co-signer debt"
  - "successor in interest confusion"
  - "sucessor in interest mortgage"
  - "mortage due after death"
  - "spouse after death mortgage"
  - "co-signer after death"
...
# What to do if… you need to handle rent or mortgage payments after someone has died (USA)
...
2. **Check whether you might be personally responsible**
...
3. **Find who can speak for the estate**
...
4. **If it is rent, contact the landlord or property manager**
...
5. **If it is a mortgage, contact the mortgage servicer**
...
6. **Separate payment from personal responsibility**
...
7. **Protect the home and the paper trail**
...
- https://www.consumerfinance.gov/rules-policy/regulations/1024/38/
