...
tags:
  ...
  - food pipe injury worry
  - can’t swallow saliva
  - drooling after swallowing
  - worsening pain swallowing
  - hoarse voice after eating
  - suspected lodged bone
  - throat prickly sensation
  - sharp bone lodged
...
## What to do now
1. **Check breathing first.** If you’re choking, have noisy breathing/stridor, trouble breathing, or can’t speak normally: **call 911**.
2. **Stop eating.** With a suspected sharp object and worsening pain, stop solid foods. If swallowing is comfortable, take **small sips of water**—but don’t force it.
3. **Go to the ER now if any red flags are present.** Go urgently if you have:
...
4. **If you’re stable but worried, use a “real person” triage route now (pick one):**
   - your clinician’s after-hours nurse line / on-call service, or
   - an urgent care advice line (if available locally).
   If symptoms are worsening and you suspect a sharp object, err toward the **ER**.
5. **Optional support while you arrange care (especially for children or if you’re unsure what was swallowed):** call **Poison Control at 1-800-222-1222**. This is not a substitute for the ER if red flags are present or pain is worsening.
6. **Write down the details before you call or travel.**
...
7. **Get help with transport if symptoms are progressing.** If you feel faint, are vomiting repeatedly, or pain is rapidly worsening, don’t drive yourself—use **911** or have someone take you.
