...
tags:
  ...
  - "medical provider payment demand"
  - "services paused over medical balance"
  - "care paused unless paid"
  - "medical bill due immediately"
  - "unexpected clinic balance"
  - "unexpected hospital balance"
  - "medical payment demanded now"
  - "what do i do if care is paused"
  - "what do i do if payment is demanded"
  - "what do i do if services are paused"
  - "what do i do if unexpected medical balance"
  - "help i was told to pay now"
  - "help i cannot pay medical balance"
  - "my medical provider demands payment"
  - "my services may be paused"
  - "provider says pay immediately"
  - "clinic says services will stop"
  - "hospital balance was unexpected"
  - "medical bill amount looks wrong"
  - "insurance claim still pending"
  - "unexpected balance or copay"
  - "unexpected balance or deductible"
  - "unexpected balance or deposit"
  - "unexpected balance or billing error"
  - "balance demanded before scheduled services"
  - "balance demanded during ongoing services"
  - "i have insurance and unexpected balance"
  - "i have no insurance and unexpected balance"
  - "my medical balance is out-of-network"
  - "my balance remains after insurance"
  - "payment demanded before treatment"
...
# What to do if… a medical provider threatens to pause your care unless you pay an unexpected balance (USA)
...
## What to do now
1. **Switch to emergency care first if needed.**  
...
3. **Ask the billing office whether a temporary hold is available.**  
...
4. **If you have insurance, call the insurer using the number on your insurance card or portal.**  
...
5. **If the charge may be an unexpected out-of-network bill, ask whether federal protections may apply.**  
...
6. **If you do not have insurance, or are not using insurance to pay, ask about a Good Faith Estimate for planned or requested services.**  
...
7. **Ask about financial assistance and payment-plan options before borrowing money.**  
