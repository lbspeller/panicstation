...
tags:
  ...
  - water cascading down exterior walls
  - downspout clogged
  - blocked downspout
  - rainwater spilling over gutters
  - water against siding
  - exterior wall water intrusion
  - basement leak after rain
  - water pooling near foundation
  - wet wall by outlets
  - protect electrical from water
  - stop water entering home
  - temporary downspout extension
  - storm water runoff problem
  - emergency home water leak
  - window well filling with water
  - report clogged storm drain
  - street flooding near house
  - downspout discharging too close
last_reviewed: "2026-03-04"
---

# What to do if… your gutters are overflowing and water is cascading down the exterior walls (USA)
## Short answer
...
## What to do now
1. **Scan indoors for electrical risk and active entry.** Check the inside of the affected exterior wall(s): dripping, wet window/door frames, damp around outlets/switches, water near light fixtures, or a sagging/bubbling ceiling.  
...
2. **If it’s safe and dry to access, turn off power to reduce shock risk.** Use the breaker panel only if you can reach it safely without wet floors/standing water. If you can’t, stay out of the wet area; call **911** if there’s immediate danger (sparking, burning smell, someone at risk).
3. **Contain immediately inside.** Put buckets/towels under drips. Move furniture, rugs, and important items away from the wall and off the floor (especially on the lowest level).
4. **Do safe, ground-level downspout/drain checks.** Clear only what you can safely reach: debris at the downspout outlet and any nearby yard/driveway drain grate that’s backing up.
5. **Temporarily divert water away from the wall and foundation.** Attach a downspout extension or flexible drain hose and route discharge **well away from the foundation** to a spot that drains away from the house (as far as practical with what you have). If you don’t have one, make a short, weighted “chute” with plastic sheeting to guide water away from vents, window wells, and door thresholds.
6. **Reduce splash and wall saturation.** Place a large container under the main spill point to cut splashback onto siding/brick, and keep water away from basement windows or window wells if applicable.
7. **Report street/storm-drain issues if they’re contributing.** If a clogged storm drain, ditch, or street inlet is causing water to back up toward homes, report it to your **city/county public works** (often via **311**, a local reporting app, or the city website).  
8. **If there’s a flooding emergency, escalate early.** If water is rising quickly, entering living areas, or anyone is in immediate danger, call **911** and follow local emergency management instructions.
...
- https://www.noaa.gov/jetstream/tc-safety
- https://www.valleywater.org/flooding-safety/flood-ready/report-creek-blockages-local-flooding
- https://www.miami.gov/My-Home-Neighborhood/Solve-a-Problem/Report-Flooding