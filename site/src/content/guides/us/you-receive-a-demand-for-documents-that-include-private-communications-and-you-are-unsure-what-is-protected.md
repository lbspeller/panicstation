...
tags:
  ...
  - "private messages in subpoena"
  - "emails demanded in legal request"
  - "chat logs requested"
  - "text messages requested"
  - "social media messages demanded"
  - "unsure what is protected"
  - "protected communications confusion"
  - "attorney-client privilege confusion"
  - "work product protection confusion"
  - "private documents disclosure worry"
  - "what do i do if documents are demanded"
  - "what do i do if messages are subpoenaed"
  - "what do i do if emails are requested"
  - "what do i do if chats are demanded"
  - "help i received a subpoena"
  - "help i got a document demand"
  - "help i have private communications"
  - "help i might disclose private messages"
  - "my private messages were requested"
  - "my emails are in a subpoena"
  - "my documents include private chats"
  - "deadline on document demand"
  - "worried about overdisclosure"
  - "unsure if subpoena is real"
  - "court paper asks for messages"
  - "lawyer emails mixed in"
  - "work emails requested"
...
# What to do if… you receive a demand for documents that include private communications and you are unsure what is protected (USA)
