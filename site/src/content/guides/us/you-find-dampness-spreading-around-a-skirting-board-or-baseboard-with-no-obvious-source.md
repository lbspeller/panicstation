...
tags:
  - dampness at baseboard
  - wet baseboard no leak
  - moisture spreading on wall bottom
  - hidden water leak in wall
  - water stain near floor trim
  - damp patch getting bigger
  - musty smell by baseboard
  - suspected plumbing leak indoors
  - leak under slab or crawlspace
  - wet drywall at floor line
  - mystery damp spot on wall
  - rain intrusion vs leak unsure
  - condensation on pipes confusion
  - water damage first steps
  - renters report water damage
  - homeowners shut off water
  - check water meter for leak
  - mold risk after dampness
  - baseboard swelling or warping
last_reviewed: "2026-03-04"
---

# What to do if… you find dampness spreading around a skirting board or baseboard with no obvious source (USA)
## Short answer
...
## What to do now
1. **Create a safer setup around electricity.**
...
2. **Run a quick “do I have an active leak?” test.**
...
3. **If it’s spreading, shut off water to limit damage.**
...
4. **Check the highest-probability sources near that wall section.**
...
5. **Start drying safely while you arrange repair.**
...
6. **Notify the right party immediately (access + liability).**
