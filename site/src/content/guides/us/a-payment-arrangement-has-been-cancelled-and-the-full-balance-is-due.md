...
tags:
  ...
  - "hardship plan ended"
  - "missed arrangement payment"
  - "what do i do if payment arrangement cancelled"
  - "what do i do if full balance due"
  - "what do i do if repayment plan ended"
  - "what do i do if lender cancelled plan"
  - "help i got full balance notice"
  - "help i missed payment arrangement"
  - "my payment plan was cancelled"
  - "my repayment plan ended suddenly"
  - "my lender wants full balance"
  - "notice says full balance due"
  - "autopay failed on payment plan"
  - "payment posted late"
  - "returned payment notice"
  - "fees added to balance"
  - "collector letter received"
  - "account sent to collections"
  - "summons with debt notice"
  - "scam debt letter"
  - "fake collection notice"
  - "loan acceleration letter"
...
# What to do if… a payment arrangement has been cancelled and the full balance is due (USA)
...
3. **Check what triggered the cancellation.**
...
4. **Ask for the reason, the balance breakdown, and a short hold.**
...
5. **If the payment failed, ask whether reinstatement is available.**
...
6. **If you cannot pay the full balance, offer a payment you can keep.**
...
7. **If this is a debt collector, use the validation and dispute process.**
...
8. **If you received court papers, switch into deadline mode.**
...
10. **Escalate if the information is missing, confusing, or pressured.**
