...
tags:
  - "car-share app will not end trip"
  - "car-share trip charges keep running"
  - "car-share rental stuck active"
  - "car-share app end trip failed"
  - "car-share return zone not accepted"
  - "car-share gps return problem"
  - "car-share app frozen at return"
  - "car-share trip still open"
  - "car-share rental will not close"
  - "car-share end button not working"
  - "what do i do if car-share wont end"
  - "what do i do if trip keeps charging"
  - "what do i do if rental stays active"
  - "what do i do if car-share app failed"
  - "help i cant end car-share trip"
  - "help i returned car-share but charged"
  - "help i parked but trip active"
  - "help i have car-share app error"
  - "my car-share trip will not close"
  - "my car-share charges keep going"
  - "end trip button greyed out"
  - "active trip after parking"
  - "app says outside return zone"
  - "poor signal ending car-share"
  - "locked car trip still active"
  - "wrong return area carshare"
  - "gps issue carshare"
  - "carshare end trip error"
  - "rideshare rental stuck"
...
# What to do if… a car-share app will not let you end your trip and charges keep running (USA)
...
- https://support.zipcar.com/hc/en-us/articles/9514926539027-How-do-I-contact-Zipcar
