...
# What to do if… you are contacted by media or people online about a family member’s death and you do not want publicity (USA)
...
3. **Verify identity only if you’re considering any response.**  
...
4. **Lock down your “surface area” quickly.**  
...
5. **Document and preserve evidence quietly.**  
...
6. **Reduce call/text volume using the tools that actually work.**  
...
7. **Escalate clearly based on what’s happening.**  
...
8. **If your family is connected to a criminal case, ask for victim support.**  
