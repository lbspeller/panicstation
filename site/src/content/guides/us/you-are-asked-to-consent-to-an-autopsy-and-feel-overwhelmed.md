...
tags:
  ...
  - "autopsy consent overwhelmed"
  - "autopsy choice after death"
  - "autopsy decision after death"
  - "hospital autopsy decision"
  - "forensic autopsy uncertainty"
  - "family autopsy disagreement"
  - "religious autopsy objection"
  - "limited autopsy question"
  - "autopsy paperwork confusion"
  - "what do i do if autopsy requested"
  - "what do i do if autopsy required"
  - "what do i do if hospital asks autopsy"
  - "what do i do if family disagrees autopsy"
  - "help i feel overwhelmed by autopsy"
  - "help i cannot decide about autopsy"
  - "my family disagrees about autopsy"
  - "my relative needs an autopsy"
  - "asked to sign autopsy consent"
  - "rushed to decide autopsy"
  - "confused about autopsy authority"
  - "unsure who decides autopsy"
  - "sudden death autopsy question"
  - "body release autopsy delay worry"
  - "autopsy report timing worry"
  - "autopsy retained organs worry"
  - "autopsy viewing concern"
  - "external examination confusion"
  - "postmortem examination confusion"
  - "clinical or forensic autopsy"
  - "autospy decision overwhelmed"
  - "autopsy decison overwhelmed"
  - "out of state autopsy question"
...
# What to do if… you are asked to consent to an autopsy and feel overwhelmed (USA)
## Short answer
...
2. **Ask the office to note one preferred family contact.**
   Say: “Please note me as the preferred family contact. Who is allowed to give instructions or receive information in this case?”
   Ask for the best phone number or email address for the relevant office, such as the medical examiner, coroner, hospital pathology department, or decedent affairs office.

3. **If this is a hospital clinical autopsy, ask to read the form before agreeing.**
   Ask:
...
4. **If this is a medical examiner or coroner case, ask what the local process allows.**
   Ask:
...
5. **Ask about the practical next steps.**
   Ask:
...
6. **If relatives disagree, narrow the issue for now.**
   Ask the hospital or office: “Who may consent, receive information, and submit requests in this case?”
   
   Say to relatives: “We can discuss the wider questions after we understand what is required and what choices actually exist.”

7. **Ask whether any other examination option is time-sensitive.**
   Ask: “Are there any other examination options, and is there anything that must be raised before release?”
