...
tags:
  - "work emails sent without me"
  - "messages sent from work account"
  - "emails i did not send"
  - "work account sending messages"
  - "unauthorized work account emails"
  - "suspicious sent emails at work"
  - "hacked work email account"
  - "work inbox sending itself"
  - "what do i do if work emails sent"
  - "what do i do if my work account sent emails"
  - "what do i do if messages sent from my account"
  - "what do i do if my inbox was hacked"
  - "help i found emails i did not send"
  - "help i saw strange sent messages"
  - "my work email is sending spam"
  - "my account sent a payment email"
  - "my sent folder has strange emails"
  - "colleagues got messages from me"
  - "unknown sent items"
  - "strange mailbox rules"
  - "unexpected forwarding rule"
  - "new sign-in alert"
  - "password reset alert"
  - "payment change email"
  - "fake invoice email"
  - "gift card request email"
  - "wire transfer email"
  - "outlook account hacked"
  - "microsoft 365 email hacked"
  - "google workspace email hacked"
  - "slack messages not mine"
...
- https://slack.com/help/articles/360002084827-View-access-logs-for-your-account
