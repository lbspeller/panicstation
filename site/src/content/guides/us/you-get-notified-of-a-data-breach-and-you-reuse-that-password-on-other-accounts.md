...
tags:
  ...
  - "data breach reused password"
  - "password reused after breach"
  - "same password on services"
  - "leaked password on accounts"
  - "compromised password on services"
  - "breach notification password"
  - "reused login after breach"
  - "what do i do if data breach"
  - "what do i do if password leaked"
  - "what do i do if password reused"
  - "what do i do if breach notice"
  - "help i reused my password"
  - "help i got breach notice"
  - "help i used same password"
  - "my password was in breach"
  - "my accounts use same password"
...
# What to do if… you get notified of a data breach and you reuse that password on other accounts (USA)
...
## What to do now
1. **Confirm the notice is real without engaging with the message.**  
...
4. **Change the reused password everywhere else you used it.**  
   Start with accounts that could cause the most damage:
   - banks, credit cards, payment apps, and tax accounts
...
5. **Turn on two-factor authentication where it matters most.**  
...
6. **Add alerts so you notice new attempts quickly.**  
...
7. **If personal information was exposed, consider credit protections.**  
...
8. **If you see signs of identity theft, use the official recovery process.**  
...
9. **Watch closely for the next few weeks.**  
