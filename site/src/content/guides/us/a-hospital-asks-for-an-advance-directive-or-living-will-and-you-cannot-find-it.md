...
tags:
  - "cannot locate advance directive"
  - "missing advance directive"
  - "lost advance directive"
  - "advance directive not on file"
  - "cannot find living will"
  - "missing living will"
  - "lost living will"
  - "hospital asks for advance directive"
  - "hospital asks for living will"
  - "health care proxy missing"
  - "medical power of attorney missing"
  - "health care agent unclear"
  - "surrogate decision maker unclear"
  - "polst form missing"
  - "molst form missing"
  - "what do i do if advance directive missing"
  - "what do i do if living will missing"
  - "what do i do if hospital needs directive"
  - "what do i do if proxy paperwork missing"
  - "help i cannot find advance directive"
  - "help i lost the living will"
  - "my advance directive is missing"
  - "my living will is missing"
  - "family cannot locate directive"
  - "patient cannot speak for themselves"
  - "urgent treatment decision without paperwork"
  - "unclear who can speak for patient"
  - "no directive copy in chart"
  - "no living will copy available"
  - "advance directive registry unclear"
  - "dnr paperwork confused with directive"
  - "polst confused with living will"
  - "advance directve missing"
  - "living wil missing"
...
# What to do if… a hospital asks for an advance directive or living will and you cannot find it (USA)
## Short answer
