...
# What to do if… your septic system alarm goes off or the septic control panel shows a warning (USA)
...
## What to do now
1. **Silence the alarm (if the panel has a silence button).** This stops the noise but doesn’t fix the problem—treat it as an active warning.
2. **Immediately cut water use to near-zero.** Tell everyone in the home: no showers, laundry, dishwasher, long handwashing, or repeated flushing. Use one toilet only if unavoidable.
3. **Check for a simple power problem you can safely confirm.**
...
4. **Look for urgent “escalation” signs.** If you have **sewage backing up**, strong sewage odors inside, multiple drains slow at once, or wet/standing water near the tank/drainfield, keep water use as close to zero as possible.
5. **Call a septic service provider (or your system’s maintenance company).** Tell them:
   - the alarm is on,
...
6. **If sewage is inside the home, treat it as a contamination hazard right now.**
...
7. **Document what you see before anything changes.** Take a photo of the panel lights/code and note the time the alarm started—this helps the technician diagnose faster.
