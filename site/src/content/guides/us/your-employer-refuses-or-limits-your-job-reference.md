...
tags:
  - "reference refused"
  - "reference limited"
  - "job reference refused"
  - "employment reference refused"
  - "former employer reference refused"
  - "reference will be limited"
  - "reference will be refused"
  - "limited employment reference"
  - "limited job reference"
  - "no employer reference"
  - "what do i do if reference refused"
  - "what do i do if reference limited"
  - "what do i do if employer refuses reference"
  - "what do i do if hr limits reference"
  - "help i have no reference"
  - "help i was refused a reference"
  - "help i only got limited reference"
  - "help i cannot get employment reference"
  - "my former employer refuses reference"
  - "my job reference is limited"
  - "my reference check is delayed"
  - "my reference was withdrawn"
  - "hr confirms dates only"
  - "hr confirms title only"
  - "reference check is stalled"
  - "recruiter says reference missing"
  - "background report has error"
  - "screening report has error"
  - "former manager will not respond"
  - "reference issue or background check"
  - "negative reference or verification only"
  - "employment verification or reference"
  - "reference refused after complaint"
  - "reference limited after leaving job"
  - "reference refused during job offer"
...
# What to do if… your employer refuses or limits your job reference (USA)
## Short answer
...
## What to do now
1. **Ask the hiring contact to identify the missing item.**  
...
2. **Contact the former employer’s HR team or verification contact.**  
   Ask:
   - what information they can confirm
...
3. **Offer the hiring contact acceptable substitutes.**  
   Depending on what they will accept, offer:
...
4. **Check whether the issue is a third-party consumer report.**  
   Ask the hiring contact whether a background screening company or consumer reporting agency produced a report. If so:
   - ask for the company name and contact details
...
5. **Record possible discrimination or retaliation concerns without escalating the first message.**  
...
6. **Correct a specific false statement calmly.**  
