---
title: "What to do if… you receive bills addressed to a person who died immediately after the death"
jurisdiction: "USA"
category: "Death, bereavement & serious family crises"
tags:
  - bills after death
  - mail for deceased person
  - invoices to someone who died
  - debt collection after loved one dies
  - medical bills after death
  - credit card bill after death
  - collectors calling after death
  - probate first steps bills
  - personal representative and bills
  - executor tasks mail and bills
  - stop paying deceased bills
  - debt details in writing
  - stop debt collector contact
  - scam bills after bereavement
  - unsure if responsible for debt
  - family member pressured to pay
  - letters addressed to deceased
  - immediate steps after death bills
last_reviewed: "2026-02-23"
---

# What to do if… you receive bills addressed to a person who died immediately after the death (USA)
...
## What to do now
1. **Start a simple “bills log.”** For each bill: sender, date received, amount, account/reference number, and whether it looks like a service bill (utilities/rent/care) or a credit/collection item.
2. **Identify who the personal representative is (or will be).**
   - If there’s a will, it may name an executor.
   - If not, a probate court typically appoints an administrator.
   If you’re not that person, your safest move is to pass the bills to them and avoid acting in your own name.
3. **Notify the sender the person has died and ask them to update records.** Keep it factual: name, date of death, and how to reach the personal representative (if known). Ask them to communicate with the estate.
4. **If a debt collector contacts you and you are *not* the personal representative, set a boundary.**
...
5. **If you *are* the personal representative, switch to “estate-only” handling.**
...
6. **Treat anything high-pressure as unverified until proven.** Urgency (“pay today”), unusual payment methods, threats of arrest, or refusal to provide written information are reasons to stop and verify using an official contact route for that company.
