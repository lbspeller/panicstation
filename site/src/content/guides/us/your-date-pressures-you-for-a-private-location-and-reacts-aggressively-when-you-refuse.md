...
tags:
  ...
  - "date pushes for privacy"
  - "date escalates when declined"
  - "date gets angry after no"
  - "date will not take no"
  - "what do i do if my date feels unsafe"
  - "what do i do if my date gets angry"
  - "what do i do if my date pushes for privacy"
  - "what do i do if my date ignores no"
  - "help i feel unsafe on a date"
  - "help i declined and they escalated"
  - "help i am pressured to leave"
  - "help i am being followed"
  - "my date wants a private location"
  - "my date is pressuring me"
  - "my date is blocking my way"
  - "my date wants me in their car"
  - "date keeps pushing after no"
  - "date follows me outside"
  - "date blocks the exit"
  - "date becomes threatening"
  - "date keeps asking to go home"
  - "date will not let me leave"
  - "date seems controlling"
  - "date is just being persistent"
  - "date is only being pushy"
  - "date is overreacting to rejection"
  - "first date from an app"
  - "first date at a bar"
...
# What to do if… your date pressures you for a private location and reacts aggressively when you refuse (USA)
...
## What to do now
1. **Move toward other people and staff.**  
...
5. **Call 911 if the situation becomes dangerous.**  
...
7. **If the person follows you outside, return to a public place.**  
   Stand near staff or other people and say clearly: “I need help. I am being followed. Please call 911.”

8. **Once you are somewhere safer, save basic information if you choose.**  
...
9. **Contact specialist support if it would help.**  
