...
tags:
  ...
  - "authentication method changed notice"
  - "two-factor method changed"
  - "mfa method changed"
  - "2fa method changed"
  - "account authentication changed"
  - "security method changed"
  - "login method changed"
  - "verification method changed"
  - "notice that 2fa changed"
  - "what do i do if two-factor changed"
  - "what do i do if mfa changed"
  - "what do i do if authentication changed"
  - "what do i do if account security changed"
  - "help i got a 2fa change notice"
  - "help i cannot use my authenticator"
  - "help i got locked out"
  - "help i see a new login method"
  - "my two-factor authentication changed"
  - "my account recovery changed"
  - "my authenticator was removed"
  - "my phone number was added"
  - "unknown device signed in"
  - "unexpected security alert"
  - "new recovery email appeared"
  - "backup codes were requested"
  - "password reset emails appeared"
  - "phone suddenly lost service"
  - "hacked account 2fa"
  - "account takeover alert"
  - "possible sim swap"
  - "authentcation method changed"
  - "two factor authentification changed"
...
# What to do if… you get a notice that your two-factor authentication method was changed without your permission (USA)
