---
title: "What to do if… you are asked to collect a child because their parent has died and the other caregiver is unreachable"
jurisdiction: "USA"
category: "Death, bereavement & serious family crises"
tags:
  - asked to pick up a child
  - parent has died
  - other parent unreachable
  - can't reach guardian
  - emergency school pickup
  - not on pickup list
  - caregiver not answering
  - sudden family death
  - temporary guardianship urgent
  - emergency custody question
  - who can pick up child
  - school won't release child
  - child needs safe adult
  - crisis childcare situation
  - bereavement logistics
  - urgent child handoff
  - unexpected call to collect child
  - minor guardian emergency
last_reviewed: "2026-02-23"
---

# What to do if… you are asked to collect a child because their parent has died and the other caregiver is unreachable (USA)
...
## What to do now
1. **Confirm exactly who is requesting this and where the child is.** Get names, roles, call-back numbers, and the child’s current location (school office, daycare, after-school program, etc.).
2. **Ask the school/childcare provider what they need to release the child.** Commonly: you must be on the authorized pickup list and show photo ID. Ask to speak with an administrator.
3. **If you are not clearly authorized, ask them to keep the child there while a plan is made.** Say plainly: “I don’t want the child released without proper authorization—please follow your safety procedures.”
4. **Try to reach the other caregiver and all emergency contacts using multiple methods.**
   - Call, text, voicemail (short, factual).
   - Ask the school/setting to call the numbers on their emergency contact card as well.
5. **If no legal guardian can be reached in time, escalate to the appropriate authority for immediate safety.**
...
6. **If the child is released to you, get the release decision documented.** Ask the school/setting to note: who approved release, what ID/checks were done, the time/date, and where the child is going.
7. **If the child needs medical care while the guardian is unreachable, don’t guess your authority.**
...
8. **Keep the first destination simple and stabilizing.** Go to a safe, calm place (ideally familiar to the child) that the releasing authority agrees is appropriate. Avoid unnecessary stops and avoid discussing adult details in front of the child.
9. **Write down a minimal incident log for yourself (2 minutes).** Note who confirmed the death (and how you were told), who you spoke with, what was authorized, and what the next official step is (CPS contact, officer name/incident number if provided, court self-help contact, etc.).
10. **If care may extend beyond “tonight,” start the temporary authority pathway quickly (names vary by state).** Look for your state/county court’s self-help information on **temporary/emergency guardianship** or **emergency custody** (terminology and which court division handles it varies). If you can’t find it fast, CPS/law enforcement can often tell you the correct local route.
