...
tags:
  ...
  - "sudden fever stiff neck"
  - "fever and photophobia"
  - "fever and neck rigidity"
  - "what do i do if fever stiff neck"
  - "what do i do if fever light hurts"
  - "what do i do if neck stiffness starts"
  - "what do i do if fever headache neck"
  - "help i have fever and stiff neck"
  - "help i have light sensitivity fever"
  - "my neck is stiff with fever"
  - "my fever came with neck pain"
  - "my eyes hurt with fever"
  - "my headache fever neck stiffness"
  - "light hurts my eyes fever"
  - "hard to bend neck fever"
  - "confused with fever and headache"
  - "sleepy with fever and stiff neck"
  - "purple rash with fever"
  - "vomiting with fever stiff neck"
  - "possible meningitis symptoms"
  - "worried about meningitis"
  - "flu or meningitis"
  - "migraine or meningitis"
  - "menigitis symptoms fever neck"
...
# What to do if… you have a fever with a stiff neck or sensitivity to light (USA)
...
2. **If this is happening to someone else, keep them observed and not alone.**
...
3. **Tell 911 or triage staff about danger signs right away.**
...
4. **Bring only the details that help fast intake.**
...
5. **Use simple comfort steps only if they do not slow leaving.**
