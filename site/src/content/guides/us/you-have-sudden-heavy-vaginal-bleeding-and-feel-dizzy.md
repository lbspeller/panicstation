...
tags:
  ...
  - "heavy vaginal bleeding outside period"
  - "unexpected heavy vaginal bleeding"
  - "abnormal vaginal bleeding with dizziness"
  - "heavy bleeding between periods"
  - "gushing vaginal bleeding"
  - "heavy bleeding not on period"
  - "dizzy during vaginal bleeding"
  - "what do i do if bleeding heavily"
  - "what do i do if bleeding starts"
  - "what do i do if dizzy from bleeding"
  - "what do i do if nearly fainting"
  - "help i am bleeding heavily"
  - "help i feel dizzy and bleeding"
  - "my vaginal bleeding is very heavy"
  - "my bleeding started outside my period"
  - "lightheaded with vaginal bleeding"
  - "weak during heavy bleeding"
  - "nearly fainting with bleeding"
  - "large clots with vaginal bleeding"
  - "pelvic pain with bleeding"
  - "shoulder pain with bleeding"
  - "short of breath with bleeding"
  - "breakthrough bleeding feels heavy"
  - "unexpected period or vaginal bleeding"
  - "miscarriage or heavy period"
  - "spotting or heavy vaginal bleeding"
  - "uterine bleeding or vaginal bleeding"
  - "possible pregnancy with bleeding"
  - "bleeding with an iud"
...
# What to do if… you have sudden heavy vaginal bleeding and feel dizzy (USA)
