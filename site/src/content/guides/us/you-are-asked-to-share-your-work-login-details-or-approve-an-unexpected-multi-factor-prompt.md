...
tags:
  - "asked to share work login details"
  - "asked to share work password"
  - "unexpected mfa prompt"
  - "unrequested mfa approval prompt"
  - "work account verification code request"
  - "repeated mfa push prompts"
  - "work account login request"
  - "suspicious work sign-in prompt"
  - "what do i do if asked for work password"
  - "what do i do if mfa prompt is not mine"
  - "what do i do if someone asks for my login"
  - "what do i do if work mfa keeps appearing"
  - "help i got an unexpected mfa prompt"
  - "help i shared my work login"
  - "my boss asked for my password"
  - "my work account has strange prompts"
  - "mfa prompt appeared unexpectedly"
  - "multiple mfa prompts in a row"
  - "login code requested by caller"
  - "work chat asks for password"
  - "fake helpdesk message"
  - "unexpected sign-in approval request"
  - "mfa fatigue prompt"
  - "push bombing at work"
  - "fake it support request"
  - "phishing message from manager"
  - "work account changed unexpectedly"
  - "remote work login request"
  - "work email login details request"
  - "teams message asks for password"
...
# What to do if… you are asked to share your work login details or approve an unexpected multi-factor prompt (USA)
## Short answer
