...
tags:
  ...
  - "mystery admin account"
  - "extra computer user"
  - "new user appeared"
  - "suspicious admin login"
  - "possible hacked computer"
  - "local administrator account"
  - "what do i do if new admin account"
  - "what do i do if unknown admin user"
  - "what do i do if computer has extra user"
  - "what do i do if local admin appeared"
  - "help i found an admin account"
  - "help i think my computer was hacked"
  - "my computer has unknown user"
  - "my pc shows new administrator"
  - "my mac has new admin"
  - "new account on login screen"
  - "usual account lost admin"
  - "administrator rights changed"
  - "account added overnight"
  - "login screen changed suddenly"
  - "admin account keeps returning"
  - "hacker made admin account"
  - "virus made admin account"
  - "malware added user"
  - "remote access scam account"
  - "unknown sudo user"
...
2. **Record the basics before changing anything else.**  
   Take a photo of the login screen or user list showing the new account. Write down:
...
3. **If this is a work, school, or managed device, stop and escalate.**  
...
4. **From a different trusted device, secure the accounts that could unlock everything else.**  
   Use your phone or another computer you trust, not the affected computer. Start with:
...
5. **Check whether there is an obvious non-criminal explanation, without taking risks.**  
...
6. **Use built-in user management only if you can do it safely.**  
...
7. **Scan using trusted tools for your operating system.**  
...
8. **If the account was truly unauthorized, plan for a clean recovery.**  
...
9. **If money, identity theft, extortion, or ransomware is involved, report and contact affected services.**  
