...
tags:
  ...
  - "app update logged me out"
  - "app update lost downloads"
  - "app update erased offline data"
  - "downloaded content missing after update"
  - "offline data gone after update"
  - "app library empty after update"
  - "app account empty after update"
  - "what do i do if app signed me out"
  - "what do i do if app downloads disappeared"
  - "what do i do if offline data is gone"
  - "what do i do if app library is empty"
  - "help i lost app downloads"
  - "help i cannot find offline content"
  - "help i am signed out after update"
  - "help i lost notes inside app"
  - "my downloaded videos are missing"
  - "my offline maps are gone"
  - "my app purchases are missing"
  - "my subscription is not showing"
  - "empty app library after update"
  - "missing offline notes after update"
  - "missing offline recordings after update"
  - "missing downloaded maps after update"
  - "app reset after update"
  - "app cache looks wiped"
  - "wrong app account signed in"
  - "app sync shows nothing"
  - "app reinstall lost content"
  - "restore purchases not working"
  - "offline mode stopped working"
  - "app update lost downloads on iphone"
  - "app update lost downloads on android"
  - "app update lost local notes"
  - "app updte signed me out"
  - "offine data gone after update"
last_reviewed: "2026-06-03"
date_created: "2026-06-03"
---

# What to do if… an app update signs you out and your downloaded content or offline data is missing (USA)
...
- https://support.apple.com/en-us/108096
