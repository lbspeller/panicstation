...
tags:
  ...
  - "work trial period extended"
  - "employment probation extended"
  - "job probation extended"
  - "probation end date changed"
  - "what do i do if probation is extended"
  - "what do i do if my probation changes"
  - "what do i do if probation ends later"
  - "what do i do if work extends probation"
  - "help i got a probation extension"
  - "help i was told probation changed"
  - "help i have unclear probation terms"
  - "help i was asked to sign probation extension"
  - "my probation was extended unexpectedly"
  - "my probation end date changed"
  - "my manager extended my probation"
  - "my probation expectations are unclear"
  - "probation extension not in writing"
  - "unclear probation end date"
  - "unclear probation expectations"
  - "asked to sign probation extension"
  - "probation extended after absence"
  - "manager says review later"
  - "performance plan during probation"
  - "trial period extension"
  - "introductory period extension"
  - "review period extension"
  - "at-will probation confusion"
  - "federal employee probation extension"
  - "union job probation extension"
  - "contract job probation extension"
  - "probation extension after leave"
...
# What to do if… your probation period is being extended unexpectedly (USA)
## Short answer
...
- https://www.ecfr.gov/current/title-5/chapter-I/subchapter-A/part-11
