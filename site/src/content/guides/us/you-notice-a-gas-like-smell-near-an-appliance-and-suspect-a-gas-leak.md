---
title: "What to do if… you notice a gas-like smell near an appliance and suspect a gas leak"
jurisdiction: "USA"
category: "Home & property emergencies"
tags:
  - gas smell near appliance
  - suspect gas leak at home
  ...
  - evacuate for gas leak
  - avoid light switches gas smell
  - apartment gas leak smell
  - gas odor when appliance off
  - faint gas smell what to do
  - strong gas smell what to do
last_reviewed: "2026-03-03"
---

# What to do if… you notice a gas-like smell near an appliance and suspect a gas leak (USA)
## Short answer
...
## What to do now
1. **Stop what you’re doing and leave.** Tell everyone to evacuate (including pets). Move to fresh air a safe distance away.
2. **Avoid sparks as you leave:** don’t touch light switches; don’t start a car in an attached garage; don’t use elevators if you can use stairs safely.
3. **Once outside, call for help:**
...
4. **Warn others only from a safe outdoor spot.** If you can do so without going back inside, tell nearby neighbors to evacuate. Otherwise, rely on **911/fire department/utility** to handle evacuation.
5. **If someone feels unwell,** keep them in fresh air. Call **911** if symptoms are significant, worsening, or anyone faints/collapses.
6. **Shutting off the gas (only if safe and quick):**
...
7. **If you’re renting or in an apartment complex:** after you’re outside and calls are made, notify the property manager/landlord that you evacuated for a suspected gas leak and have contacted 911/utility/supplier.
