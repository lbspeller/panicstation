---
title: "What to do if… you are asked to collect belongings of a person who died from a hospital or facility"
jurisdiction: "USA"
category: "Death, bereavement & serious family crises"
tags:
  - collecting belongings after death
  - hospital decedent belongings
  - pick up property of deceased
  - next of kin property release
  - decedent affairs office
  - patient property release form
  - valuables clothing personal effects
  - what to bring to collect belongings
  - proof of identity for release
  - authorized representative belongings
  - funeral home holds personal effects
  - medical examiner property release
  - coroner investigation belongings held
  - property held as evidence
  - inventory receipt for belongings
  - nursing home belongings pickup
  - hospice belongings after death
  - hospital safe valuables bag
  - deceased patient phone wallet keys
last_reviewed: "2026-02-23"
---

# What to do if… you are asked to collect belongings of a person who died from a hospital or facility (USA)
...
## What to do now
1. **Call and identify the exact office that releases property.**  
   Ask the unit for the number for **Decedent Affairs / Patient Relations / Security / Property Office** (names vary). Ask:
   - where belongings are stored,
   - whether you need an appointment,
   - which forms they require,
   - who is allowed to pick items up.

2. **Ask what they accept today as proof you’re allowed to receive the items.**  
   Typically they’ll want:
   - a government photo ID, and
...
3. **Ask whether property is being routed through a coroner/medical examiner or funeral home.**  
   If a coroner/medical examiner is involved, ask:
   - whether belongings are released directly to next-of-kin by appointment at the ME/OCME,
...
4. **Go prepared and request an inventory + signed receipt.**  
   When you collect items, ask for:
   - an itemized inventory (if available), and
...
5. **If something is missing, ask the “separate storage” questions immediately.**  
   Ask:
   - “Is anything in a safe/security office?”
...
6. **Handle medications and medical equipment safely.**  
   Ask staff what to do with:
   - leftover prescription medications (don’t give them to others), and
   - any loaner/durable medical equipment (wheelchair, oxygen equipment, etc.).  
   Write down return instructions before you leave.

7. **If this is a nursing home/hospice/assisted living facility, ask about storage deadlines.**  
