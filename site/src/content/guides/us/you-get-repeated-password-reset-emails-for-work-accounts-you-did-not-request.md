...
tags:
  ...
  - "work account reset emails"
  - "work login reset messages"
  - "unexpected password reset emails"
  - "suspicious work account emails"
  - "work email security alerts"
  - "account reset emails"
  - "reset emails for work"
  - "what do i do if password reset emails keep coming"
  - "what do i do if work account reset emails arrive"
  - "what do i do if i got reset emails"
  - "what do i do if someone requests my password"
  - "help i got password reset emails"
  - "help i keep getting login alerts"
  - "help i did not request a reset"
  - "help i clicked a reset email"
  - "my work account got reset emails"
  - "my work email has login alerts"
  - "many reset emails at once"
  - "reset emails every few minutes"
  - "unknown device login alert"
  - "unexpected security code email"
  - "mfa prompt i did not request"
  - "mailbox rules look changed"
  - "email forwarding looks unfamiliar"
  - "not sure if reset email is real"
  - "not sure if work account hacked"
  - "password reset spam or attack"
  - "phishing or real reset email"
  - "passwrod reset emails"
  - "work acount reset email"
...
2. **Report it to IT or security using a known-good method.**  
   Use your normal helpdesk number, internal portal, company phishing-report button, or a company chat channel you already trust. Do not use contact details inside the reset emails. Include:
...
3. **Ask IT or security to check for account access and persistence.**  
...
4. **Only change your password through an official company route.**  
...
5. **Check visible account settings if you can do so safely.**  
...
6. **Escalate immediately if you interacted with the email.**  
...
7. **Warn the right person if your role can trigger payments or data changes.**  
