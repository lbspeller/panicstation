...
tags:
  - "joint account changed settings"
  - "joint bank account changed"
  - "shared account settings changed"
  - "account holder changed details"
  - "joint holder changed contact details"
  - "joint account payee added"
  - "joint account alerts switched off"
  - "joint account access changed"
  - "shared current account changed"
  - "major bank account change"
  - "what do i do if joint account changed"
  - "what do i do if account settings changed"
  - "what do i do if joint holder changed details"
  - "what do i do if bank alerts stopped"
  - "help i found new payees"
  - "help i cannot access online banking"
  - "help i think my joint account changed"
  - "help i lost bank alerts"
  - "my joint account settings changed"
  - "my account contact details changed"
  - "my shared account looks different"
  - "my joint account has new payees"
  - "new payee appeared"
  - "bank alerts stopped"
  - "paperless statements turned on"
  - "contact details look wrong"
  - "online banking locked me out"
  - "standing order changed"
  - "direct debit changed"
  - "overdraft setting changed"
  - "bank account hacked"
...
# What to do if… a joint account holder changes your account settings without your knowledge (UK)
...
## What to do now
1. **Use a private device and a safer moment if you can.** Use your own phone or computer, not a shared one. If you think your email account is compromised, do not rely on email for security resets until it is secured.

2. **Contact the bank through a safe route.** Use the number on your card, the bank’s official app, or dial 159 to reach many UK banks safely.
...
3. **Ask what protective controls the bank can apply today.** Depending on the account terms and mandate, ask whether they can:
...
4. **Ask the bank to review the change history with you.** Ask specifically whether any of these changed:
...
5. **Check transactions and scheduled payments now.** Look for transfers you did not make, new payees, edited standing orders, changed direct debits or unusual card payments. If anything looks wrong, tell the bank you are reporting suspected fraud or disputed transactions and ask how they want it logged.
...
7. **Make a brief same-day record.** Use the bank’s secure message centre or official complaints route if available. Include what changed, when you noticed, what you have already asked the bank to do, and that you want the account secured and the change reviewed.

8. **If the bank says the other joint holder was allowed to make the change, ask what control is available now.** Ask: “What changes require both holders under this mandate? Can extra verification be added to my profile? What options exist to stop further unilateral setting changes?” If the answer is not workable, ask how to start a formal complaint so there is a record.

9. **Protect incoming money that is due soon.** If wages, benefits or another important payment is due in the next few days and you are worried funds could be moved, ask the payer what the fastest safe way is to change where the payment is sent. Opening a sole account may be an option, but you do not have to decide every longer-term money issue today.

10. **If this may be fraud rather than only a joint-account disagreement, report it.** If you are in England, Wales or Northern Ireland, use Report Fraud. If you are in Scotland, report fraud via 101.
