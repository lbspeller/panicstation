...
tags:
  - "urgent case number email"
  - "cannot verify sender email"
  - "case number email"
  ...
  - "fake police email"
  - "fake prison email"
  - "fake probation email"
  - "legal notice email"
  - "what do i do if case number email"
  - "what do i do if email says urgent action"
  - "what do i do if sender cannot be verified"
  - "what do i do if legal email looks fake"
  - "help i got a case number email"
  - "help i clicked a case email"
  - "my case number email looks fake"
  - "my legal email seems suspicious"
  - "sender address looks wrong"
  - "email has official logo"
  - "email threatens arrest"
  - "email demands payment"
  - "email has attachment"
  - "email has qr code"
  - "case number scam"
  - "summons email scam"
  - "warrant email scam"
  - "phishing legal email"
  - "suspicious case nmber email"
  - "urgant case email"
  - "unexpected court email"
  - "unexpected police email"
  - "payment demanded by email"
  - "identity documents requested email"
  - "work email case number"
  - "mobile email case number"
last_reviewed: "2026-07-17"
date_created: "2026-05-19"
---

# What to do if… you receive an email about a case number that requires urgent action but you cannot verify the sender (UK)
...
6. Forward the suspicious email to report@phishing.gov.uk. After forwarding it, mark it as spam or junk in your email app.
