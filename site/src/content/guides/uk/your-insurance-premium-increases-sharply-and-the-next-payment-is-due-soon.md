...
tags:
  ...
  - "renewal premium jumped"
  - "renewal price shock"
  - "renewal quote too high"
  - "monthly insurance payment jumped"
  - "direct debit higher than expected"
  - "auto-renewal price increase"
  - "what do i do if insurance premium increased"
  - "what do i do if renewal price doubled"
  - "what do i do if insurance bill is due"
  - "what do i do if direct debit is higher"
  - "help i cannot afford insurance"
  - "help i got a huge renewal quote"
  - "help i might miss insurance payment"
  - "help i need insurance cover"
  - "my insurance premium has increased"
  - "my renewal payment is too high"
  - "my direct debit amount changed"
  - "my insurance payment is due"
  - "premium much higher than last year"
  - "renewal notice confusing"
  - "wrong amount showing"
  - "payment date very close"
  - "cover might lapse"
  - "direct debit looks wrong"
  - "renewal or mid-term change"
  - "insurer price rise or error"
  - "premium or instalment confusion"
  - "cant afford insurance payment"
  - "insurence premium increased"
