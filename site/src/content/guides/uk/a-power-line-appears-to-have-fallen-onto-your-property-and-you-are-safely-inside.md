---
title: "What to do if… a power line appears to have fallen onto your property and you are safely inside"
jurisdiction: "UK"
category: "Home & property emergencies"
tags:
  - power line down on property
  - fallen power line at home
  - downed electricity line outside house
  - cable on garden or driveway
  - overhead line on fence
  - wire on roof or shed
  - power cable sparking outside
  - electricity line brought down by storm
  - live wire near house
  - power line near window
  - power line on car on drive
  - tree on power line in garden
  - power cut and fallen line
  - keep kids inside power line
  - report fallen line 105
  - scared to go outside power line
  - possible live cable outside
  - fallen wire not sure what it is
last_reviewed: "2026-03-04"
---

# What to do if… a power line appears to have fallen onto your property and you are safely inside (UK)
...
## What to do now
1. **Keep people and pets inside.** Move everyone into an internal room away from the side of the property where the line is, and keep them there.
2. **Stay back from windows and doors near the line.** If curtains/blinds are open, close them from a safe distance.
3. **Report it to the electricity network operator:**
   ...
   Say:
   - you believe an overhead power line is down on your property
...
4. **If there is immediate danger, call 999.** Examples: the line is arcing/sparking, a fire has started, someone is at risk of touching it, or it’s blocking a public path and people are approaching.
5. **Stop anyone else going outside.** If you can do so safely, put a note on the inside of the main exit (“DO NOT GO OUT — POWER LINE DOWN”) and message household members/nearby neighbours to keep away (do not ask them to investigate).
6. **Only if you must leave due to a separate immediate danger (fire/smoke inside):**
