...
# What to do if… water is coming in around a window or door during a storm (UK)
## Short answer
...
## What to do now
1. **Get everyone into a safer, drier room first (including pets).** Close interior doors to slow spread; put a towel at the bottom of the leaking doorway if that helps.
2. **Make electricity safer before you do anything else.**
...
3. **Contain the leak immediately (from the inside).**
...
4. **Move the right things, in the right order (30–60 seconds of triage).**
...
5. **Reduce water spreading into the building fabric.**
...
7. **Escalate if it’s becoming unsafe.**
