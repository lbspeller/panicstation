...
tags:
  ...
  - cellar wall wetness
  - basement damp getting worse
  - water coming through masonry wall
  - groundwater seepage basement
  - rainwater coming into basement
  - basement leak no pooling yet
  - early signs of basement flooding
  - water staining on basement wall
  - wet wall in cellar
  - seepage behind paint basement
  - basement wall weeping
  - sudden damp patch basement
...
# What to do if… you notice water seeping through a basement wall even before it starts pooling (UK)
...
## What to do now
1. **Make a safer pause.** Keep children/pets out. Assume slip risk and possible electric shock risk if water is near wiring, sockets, appliances, or extension leads.
2. **If you can do it from a dry place, isolate electricity to the basement/affected circuits.** If you cannot reach your main switch/consumer unit without entering a damp area, **do not try**. Call a registered electrician, or call **105** (free) if you need your local electricity network operator (DNO) for safety advice/help.
3. **Check quickly for an internal “escape of water” source (only if safe to 접근).**
...
4. **If it’s likely rain/groundwater seepage, focus on limiting spread and protecting what matters.**
...
5. **Document while it’s early.** Take photos/video of: where the water is coming through, any cracks, how far the damp patch extends, and anything already affected. Note the time and recent rainfall.
6. **Contact the right help early (before it becomes standing water).**
...
7. **If you have a sump pump:** only check/operate it if you can do so **without** entering the affected wet area and you’re confident power there is safe. Otherwise, leave it and tell your insurer/contractor that you have one.
8. **Watch for “escalation” triggers.** If the wet area is expanding quickly, water starts to pool, you smell gas, or you see cracking/bulging, step back and seek professional help urgently.
