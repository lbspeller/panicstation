...
tags:
  ...
  - renter damp emergency
  - landlord repair urgent
  - home water damage now
last_reviewed: "2026-03-04"
---

# What to do if… you notice a new damp patch forming on a wall and it is expanding hour by hour (UK)
...
## What to do now
1. **Make a safer pause and check for obvious electrical danger.**  
...
2. **If it’s safe to do so, isolate electricity for the affected area.**  
...
3. **Reduce water use immediately, then shut off the supply if the patch keeps growing.**  
...
4. **Quickly triage the most likely source (no invasive checks).**  
...
5. **Get the right person on the way (do this early).**  
...
6. **Limit damage safely while waiting.**  
...
7. **Ventilate gently; prioritise stopping the source.**  
