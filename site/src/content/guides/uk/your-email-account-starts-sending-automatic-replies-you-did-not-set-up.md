...
tags:
  ...
  - "email automatic replies not mine"
  ...
  - "email replying by itself"
  - "account sending auto replies"
  - "what do i do if email replies itself"
  - "what do i do if my email is hacked"
  - "what do i do if automatic replies appear"
  - "what do i do if forwarding was added"
  - "help i found email rules"
  - "help i see suspicious sign-ins"
  - "help i cannot stop auto replies"
  - "my email is sending replies"
  - "my out of office changed"
  - "my gmail sends replies"
  - "my outlook sends replies"
  - "unknown auto reply"
  - "unknown email filter"
  - "unknown forwarding address"
  - "strange sign-in alert"
  - "messages marked as read"
  - "sent replies to strangers"
  - "hidden mailbox rule"
  - "spam auto response"
  - "compromised email account"
  - "hacked email account"
  - "email acount hacked"
  - "automatc reply not mine"
...
# What to do if… your email account starts sending automatic replies you did not set up (UK)
...
10. **Report suspicious emails that may have started this.** Forward suspicious emails to report@phishing.gov.uk, then delete the original.
