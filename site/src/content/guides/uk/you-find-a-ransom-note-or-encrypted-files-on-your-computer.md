...
tags:
  ...
  - "ransom-style note file"
  - "ransom note on computer"
  - "new note file on desktop"
  - "ransomware note on pc"
  - "computer ransom message"
  - "readme ransom instructions"
  - "files suddenly encrypted"
  - "strange file extensions"
  - "what do i do if ransom note appears"
  - "what do i do if read me file appears"
  - "what do i do if computer says pay bitcoin"
  - "what do i do if files are encrypted"
  - "help i found a ransom note"
  - "help i found a read me file"
  - "help i cannot open files"
  - "help i see ransom instructions"
  - "my computer has a ransom note"
  - "my files have strange names"
  - "my desktop shows a ransom demand"
  - "my shared folder is encrypted"
  - "new txt note appeared"
  - "new html note appeared"
  - "files renamed suddenly"
  - "folders full of ransom notes"
  - "desktop wallpaper ransom message"
...
# What to do if… you find a ransom note or encrypted files on your computer (UK)
