...
tags:
  ...
  - pinprick spots rash
  - rash not going away when pressed
  - fever with purple spots
  - child fever spots
  - adult fever spots
  - suddenly ill and rash
  - fever getting worse fast
  - worried it could be sepsis
  - worried it could be meningitis
  - rash hard to see on dark skin
last_reviewed: "2026-02-21"
---

# What to do if… you have a fever and a rash that does not fade when you press on it (UK)
...
## What to do now
1. **Call 999 immediately.** Say: “**Fever and a rash that does not fade when a glass is rolled over it (non-blanching rash)**.” Describe how the person is right now (alert/confused, breathing, severe headache, stiff neck, vomiting, cold hands/feet, rapidly worsening).
2. **Get into the safest “ready” position while help is arranged.** Sit or lie down somewhere warm and visible. If you can do so safely, unlock the door and keep your phone on speaker.
3. **Check the rash once, briefly (do not keep re-testing).** If you have a clear glass, roll/press it gently but firmly over a few spots for a second or two. If the spots still show, treat it as non-blanching and focus on getting to emergency care.
...
4. **Gather essentials to take with you (without slowing down the emergency response):**
...
5. **If the person becomes very drowsy, collapses, or has trouble breathing:** stay on the line with 999, follow call-handler instructions, and be ready to start basic life support if instructed.
