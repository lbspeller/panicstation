...
tags:
  ...
  - "urgent identity documents"
  - "48 hour identity deadline"
  - "unexpected compliance notice"
  - "official-looking document request"
  - "passport scan request"
  - "driving licence copy request"
  - "proof of address request"
  - "what do i do if compliance notice"
  - "what do i do if id requested"
  - "what do i do if passport requested"
  - "what do i do if deadline is 48 hours"
  - "help i received compliance notice"
  - "help i was asked for id"
  - "my passport is being requested"
  - "my driving licence was requested"
  - "pressure to send documents"
  - "suspicious upload link"
  - "unknown reference number"
  - "unexpected qr code link"
  - "new email address request"
  - "official deadline pressure"
  - "phishing or compliance review"
  - "scam or real notice"
  - "fake compliance letter"
  - "identity theft worry"
  - "goverment id request"
  - "complicance review notice"
  - "email compliance notice"
  - "text message compliance notice"
  - "posted compliance letter"
last_reviewed: "2026-05-17"
date_created: "2026-05-17"
---

# What to do if… you receive an urgent notice demanding identity documents within 48 hours (UK)
...
## What to do now
1. **Keep the notice exactly as received.** Save the email or text, take screenshots, keep attachments, and keep the envelope if it came by post. Note when it arrived and the deadline it claims.

2. **Check who the notice claims to be from without using the notice itself.**
...
3. **Ask the verified organisation to confirm the request.** Use a verified channel and ask:
...
4. **If it is an email or text and you are unsure, report it and do not continue through that channel.**
...
5. **If the request is confirmed as genuine, use the safest available document route.**
...
6. **Limit reuse risk before sending images.**
...
7. **If you already clicked a link, uploaded documents, or gave details, contain the risk now.**
