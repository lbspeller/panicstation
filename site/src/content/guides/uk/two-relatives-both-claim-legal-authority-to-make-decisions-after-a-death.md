---
title: "What to do if… two relatives both claim legal authority to make decisions after a death"
jurisdiction: "UK"
...
tags:
  ...
  - decisions after death conflict
  - family arguing over will
  - funeral decision disagreement
  - probate authority unclear
  - grant of probate pending
  - letters of administration dispute
  - sibling says they are executor
  - relative claims probate papers
  - contested probate first steps
  - estate decisions dispute
  - who can access bank account
  - who can deal with property
  - conflicting instructions to banks
  - bereavement family conflict
last_reviewed: "2026-02-23"
---

# What to do if… two relatives both claim legal authority to make decisions after a death (UK)
...
## What to do now
1. **Work out which UK legal route applies (this changes what “proof” looks like):**
...
2. **Set a single, neutral boundary you can repeat:** “Until authority is verified, I will only act on instructions from the person who can show the correct legal proof for where the deceased lived.”
3. **Ask both relatives (separately) for the same specific proof in writing:**
...
4. **Locate the latest will (without “awarding” control):**
...
5. **Protect the estate from irreversible changes:**
...
6. **Tell organisations “authority is disputed”:** if banks, insurers, landlords, care providers, or utilities contact you, say: “There is a dispute about who is authorised. Please require the appropriate court proof before acting on instructions.”
7. **If someone is rushing to get a court document issued to “win,” consider the right “pause” tool for the right jurisdiction:**
...
8. **If there are urgent practical decisions (for example, funeral arrangements):** aim for reversible choices (delay final commitments where possible) and tell the funeral director that authority is disputed and you’re verifying who can lawfully instruct.
