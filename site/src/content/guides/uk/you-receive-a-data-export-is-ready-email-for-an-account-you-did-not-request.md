...
tags:
  ...
  - "data export email not requested"
  - "unexpected data export email"
  - "account export ready email"
  - "account data download notice"
  - "account data export notice"
  - "suspicious data export email"
  - "unauthorised data export request"
  - "data download i didnt request"
  - "privacy export notification"
  - "what do i do if data export email"
  - "what do i do if account export ready"
  - "what do i do if i didnt request export"
  - "what do i do if download ready email"
  - "help i got data export email"
  - "help i didnt request account export"
  - "help i think account was accessed"
  - "help i clicked export email"
  - "my account says export ready"
  - "my email got export notice"
  - "login activity i dont recognise"
  - "export requested without me"
  - "unfamiliar device on account"
  - "password reset emails missing"
  - "forwarding rules i dont recognise"
  - "official looking export email"
  - "phishing or real export email"
  - "scam export notification"
  - "hacked account or phishing"
...
8. **Report the message safely.**  
   If it looks like a scam email, forward it to report@phishing.gov.uk without clicking its links. If you have lost money or been hacked after responding to a phishing message, use Report Fraud if you are in England, Wales, or Northern Ireland; if you are in Scotland, contact Police Scotland on 101.
