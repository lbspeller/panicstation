...
tags:
  ...
  - "cash ledger deficit"
  - "what do i do if brokerage account negative"
  - "what do i do if margin call"
  - "what do i do if cash balance negative"
  - "what do i do if broker wants money"
  - "help i got margin called"
  - "help i owe my broker"
  - "help i have negative cash"
  - "help i might be liquidated"
  - "my trading account is negative"
  - "my brokerage balance changed suddenly"
  - "my margin requirement increased"
  - "my broker says deposit money"
  - "red negative cash figure"
  - "margin warning message"
  - "positions may be closed"
  - "unexpected account deficit"
  - "unsettled trade cash"
  - "fx conversion debit"
  - "options assignment debit"
...
# What to do if… your brokerage or trading account shows a sudden negative cash balance or margin call (UK)
