...
tags:
  ...
  - landlord repair urgent
  - vulnerable person overheating
last_reviewed: "2026-03-04"
---

# What to do if… your heating is stuck on and the indoor temperature is rising beyond what feels safe (UK)
## Short answer
...
## What to do now
1. **Move everyone (and pets) to the coolest available space** (often a shaded, lower-floor room). Cool it fast: close curtains/blinds on sunny windows, open windows on opposite sides (if safe), and use a fan if you have one.
2. **Try the “normal off” controls (quick wins):**
...
3. **If it’s still heating, isolate the heating system safely:**
...
4. **If a CO alarm sounds or you suspect CO:** get everyone into **fresh air immediately** (outside if possible), open doors/windows on your way out, then call the appropriate gas emergency number:
   ...
   If anyone is severely unwell, call **999**.
5. **If anyone seems heat-unwell, cool them now:**
