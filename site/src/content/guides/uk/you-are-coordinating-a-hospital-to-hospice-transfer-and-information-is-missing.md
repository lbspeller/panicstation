...
tags:
  - "rapid hospital hospice handover"
  - "hospital to hospice handover"
  - "hospice handover information missing"
  - "missing hospital discharge information"
  - "urgent hospice transfer confusion"
  - "asked to coordinate hospice transfer"
  - "rapid handover from hospital"
  - "hospital hospice discharge problem"
  - "what do i do if hospital handover missing"
  - "what do i do if hospice transfer rushed"
  - "what do i do if discharge papers missing"
  - "what do i do if medication list missing"
  - "help i am coordinating hospice handover"
  - "help i have missing hospice information"
  - "help i feel pressured over discharge"
  - "help i do not understand hospice handover"
  - "my relative hospice transfer is today"
  - "my family member discharge papers missing"
  - "my hospital hospice handover is unclear"
  - "my hospice admission has missing information"
  - "medication list missing"
  - "allergy information missing"
  - "resuscitation status unclear"
  - "dnacpr form missing"
  - "symptom plan unclear"
  - "transport time unclear"
  - "equipment not delivered"
  - "out of hours plan missing"
...
# What to do if… you are coordinating a hospital to hospice transfer and information is missing (UK)
...
## What to do now
1. **Name the problem clearly and ask who is leading the discharge.**
...
2. **Ask for the minimum safe handover set in writing.**
   Ask for:
...
3. **Ask the ward pharmacy or medicines team to check the medicines before transfer.**
...
4. **Call the hospice admissions or clinical team and do a receipt check.**
...
5. **Confirm equipment and transport as facts, not assumptions.**
...
6. **Write down the out-of-hours plan before the person leaves hospital.**
...
7. **Escalate calmly if the transfer is being pushed without safety basics.**
