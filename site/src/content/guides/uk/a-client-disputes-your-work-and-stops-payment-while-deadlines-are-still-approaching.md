...
tags:
  ...
  - "what do i do if invoice is disputed"
  - "what do i do if deadline is approaching"
  - "help i delivered work and was not paid"
  - "help i have a disputed invoice"
  - "help i am being asked for free changes"
  - "help i have unpaid client work"
  - "my client says work is incomplete"
  - "my client will not sign off"
  - "missing written approval"
  - "unclear acceptance criteria"
  - "rushed unpaid revisions"
  - "disputed project scope"
  - "freelance client nonpayment"
...
# What to do if… a client disputes your work and stops payment while deadlines are still approaching (UK)
...
- https://www.smallbusinesscommissioner.gov.uk/help-and-guidance/make-an-enquiry/
