...
tags:
  ...
  - internal stop tap
  - leak on supply pipe
  - leak outside property
  - water company emergency leak
  - flooding risk from leak
  - leak under floorboards
  - leak in walls
  - leak in loft tank
  - shared building water leak
  - landlord water leak emergency
...
2. **Turn off your internal stop valve (stopcock).**  
...
3. **If you can access your water meter, do a quick “is it still moving?” check.**  
   With all water use stopped and your stopcock as closed as you can get it, note the meter reading (or movement). Check again after a short wait (about **10–30 minutes**).  
   - **Any continued movement/increase** suggests water is still flowing somewhere (often a leak, or the stopcock not fully closed).

4. **Scan for the most dangerous signs (30–60 seconds).**  
...
5. **Check whether it’s likely your property or the wider supply.**  
...
6. **Contact the right help based on what you found.**
...
7. **If you couldn’t shut the stopcock fully, don’t wait to “see.”**  
...
8. **Limit damage while you wait (only if safe).**
...
9. **Record what happened (quickly).**  
