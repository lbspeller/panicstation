...
tags:
  ...
  - iv site bruising and swelling
  - painful drip site
  - injection site getting redder
  - swelling around cannula after discharge
  - iv site infection worry
  - arm swelling after cannula
  - red streak from iv site
  - iv site leaking fluid
  - iv site burning sensation
  - pain around venflon
last_reviewed: "2026-02-23"
---

# What to do if… you notice increasing redness, pain or swelling around an IV site after an infusion or injection (UK)
...
## What to do now
1. **Stop using the IV/line (if it’s still in place)** and **tell a nurse immediately** if you’re still in hospital/clinic. If you’re already home, **call the infusion unit/ward/day unit** that treated you (use the number on your discharge paperwork).
2. **Check for “urgent” red flags** and act on them:
...
3. **Mark and document the change (takes 60 seconds):**
...
4. **Protect the area while you wait for clinical advice:**
...
5. **If you can’t reach the treating team, call NHS 111.** Say: “My IV/cannula site is getting more red/painful/swollen after an infusion/injection. I’m worried about infection or an IV leak into the tissue.”
6. **If you had chemotherapy (or you were given a chemo advice number), use that advice line urgently.** If you don’t have a number, go via **NHS 111 or A&E** and tell them what was infused if you know.
