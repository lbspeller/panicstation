...
tags:
  ...
  - "listed medical contact unreachable"
  - "emergency contact not answering"
  - "next of kin not answering"
  - "hospital cannot reach family"
  - "family contact unreachable"
  - "treatment decisions being discussed"
  - "what do i do if medical contact unreachable"
  - "what do i do if hospital cannot reach family"
  - "what do i do if next of kin not answering"
  - "what do i do if treatment decisions happening"
  - "help i cannot reach medical contact"
  - "help i am not the medical contact"
  - "help i do not know who decides"
  - "help i missed a hospital call"
  - "my medical contact is unreachable"
  - "my family member is in hospital"
  - "my phone number is wrong"
  - "my relative cannot make decisions"
  - "phone off no signal"
  - "wrong number in hospital notes"
  - "hospital asking me to decide"
  - "urgent consent question"
  - "capacity unclear in hospital"
  - "family abroad unreachable"
  - "contact details outdated"
  - "blocked withheld hospital number"
  - "healthcare proxy missing"
  - "attorney details missing"
  - "medicle contact unreachable"
...
# What to do if… the person listed as a medical contact cannot be reached during urgent treatment decisions (UK)
...
## What to do now
1. **Say the problem plainly and ask for a safe pause.**  
...
3. **Ask staff to check for any authority or recorded wishes.**  
...
4. **Give concrete contact leads without guessing authority.**  
...
5. **Ask how the hospital can make contact under its policy.**  
...
6. **Ask about an advocate if nobody suitable can be reached.**  
...
7. **Get one named route for updates.**  
