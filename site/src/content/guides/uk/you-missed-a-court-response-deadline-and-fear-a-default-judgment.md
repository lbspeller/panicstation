...
tags:
  ...
  - "default judgement panic"
  - "deafult judgment"
  - "what do i do if default judgment"
  - "what do i do if i missed court deadline"
  - "what do i do if claim form missed"
  - "what do i do if court papers late"
  - "what do i do if judgment entered"
  - "help i missed court papers"
  - "help i missed response deadline"
  - "help i got default judgment"
  - "help i ignored claim form"
  - "my court response is late"
  - "my claim form arrived late"
  - "my papers went old address"
  - "papers served old address"
  - "judgment without hearing"
  - "claim deadline already passed"
  - "court form not received"
  - "default judgment not sure"
  - "set aside confusion"
  - "recall decree confusion"
  - "mcol claim confusion"
  - "county court claim"
...
# What to do if… you missed a court response deadline and fear a default judgment (UK)
...
- https://www.stepchange.org/debt-info/northern-ireland-ccj/set-aside-northern-ireland-ccj.aspx
