...
tags:
  - "two-factor changed without me"
  - "two-factor authentication changed"
  - "two-factor method changed notice"
  - "2fa method changed without me"
  - "mfa changed without me"
  - "authenticator app changed without me"
  - "security settings changed without me"
  - "recovery email changed without me"
  - "phone number changed on account"
  - "account takeover alert"
  - "hacked account 2fa changed"
  - "locked out after 2fa change"
  - "unknown device signed in"
  - "suspicious login notice"
  - "unexpected security email"
  - "verification method replaced"
  - "possible sim swap account"
  - "what do i do if 2fa changed"
  - "what do i do if mfa changed"
  - "what do i do if account security changed"
  - "what do i do if authenticator changed"
  - "help i got a 2fa alert"
  - "help i cannot access my account"
  - "help i think my account is hacked"
  - "help i lost my authenticator access"
  - "my recovery email was changed"
  - "my phone number was added"
  - "my account has unknown devices"
  - "my backup codes were changed"
  - "new login location shown"
  - "security code requests appeared"
  - "password reset emails arrived"
...
# What to do if… you get a notice that your two-factor authentication method was changed without your permission (UK)
