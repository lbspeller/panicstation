...
tags:
  - "work email used for accounts"
  - "work email address misused"
  - "work address on unknown accounts"
  - "email address used without permission"
  - "unknown accounts using work email"
  - "accounts i do not recognise"
  - "unrecognised accounts with work email"
  - "work email signup emails"
  - "what do i do if work email is used"
  - "what do i do if my work email was used"
  - "what do i do if unknown accounts use my email"
  - "what do i do if i get signup emails"
  - "help i got account emails"
  - "help i do not recognise accounts"
  - "help i think my work email is compromised"
  - "help i got verification emails"
  - "my work email is on accounts"
  - "my email address was used"
  - "my work address was used"
  - "my inbox has welcome emails"
  - "verification emails i did not request"
  - "password reset emails i did not request"
  - "welcome emails i do not recognise"
  - "subscription confirmations at work"
  - "inbox rules changed"
  - "email forwarding i did not set"
  - "unusual sign-in alert at work"
  - "work account access alert"
...
# What to do if… you receive unexpected account verification or welcome emails at your work address (UK)
...
3. **Use the UK suspicious-email fallback only if it fits your workplace process.**  
   If you cannot quickly find an internal reporting route, and your workplace allows external reporting, suspicious emails can be forwarded to report@phishing.gov.uk. This reports suspicious messages to the NCSC; it does not replace your workplace incident process or restore access to any account.

4. **Ask IT or security to check for mailbox misuse.**  
...
6. **Make a short list of the unknown account emails.**  
...
7. **Escalate internally if there is any sign of data exposure or impersonation.**  
