...
tags:
  ...
  - key left in door
  - door won’t open
  - landlord has spare key
  - letting agent emergency number
  - urgent home entry
  - emergency locksmith
  - rogue locksmith scam
  - no coat no phone
  - child locked inside
...
# What to do if… you are locked out of your home and the weather or time of day makes it urgent (UK)
## Short answer
...
## What to do now
1. **Move yourself (and anyone with you) into warmth and light.**
...
2. **Do a fast, non-damaging check (30–60 seconds).**
...
3. **Call the fastest legitimate “keyholder” option.**
...
4. **If you need a locksmith, choose one in a way that reduces rogue-trader risk.**
...
5. **Prepare to show you’re allowed entry (so you don’t get stuck outside longer).**
...
6. **If you feel unsafe where you are, change the plan.**
