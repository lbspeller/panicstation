...
tags:
  - "hr delays unwanted behaviour"
  - "hr ignoring unwanted behaviour"
  - "hr not acting"
  - "workplace behaviour escalating"
  - "unwanted behaviour at work"
  - "repeated unwanted behaviour"
  - "harassment at work escalating"
  - "bullying at work escalating"
  - "coworker behaviour escalating"
  - "manager ignoring behaviour"
  - "what do i do if hr delays"
  - "what do i do if hr ignores me"
  - "what do i do if behaviour escalates"
  - "what do i do if work feels unsafe"
  - "help i reported harassment"
  - "help i feel unsafe at work"
  - "help i am being intimidated"
  - "help i cannot face work"
  - "my complaint is being ignored"
  - "my workplace complaint is delayed"
  - "my manager is not acting"
  - "my coworker keeps contacting me"
  - "unwanted messages at work"
  - "repeated comments at work"
  - "private confrontations at work"
  - "threatening behaviour at work"
...
# What to do if… HR is ignoring your reports of repeated unwanted behaviour at work and the situation is escalating (UK)
...
2. **Start or update a simple incident log now.**  
...
3. **Escalate in writing to HR and a more senior route.**  
   Use a short email title such as: “Escalation: repeated unwanted behaviour — interim safety measures requested”. Include:
   - that the behaviour is repeated and escalating
...
4. **Say plainly if the behaviour may be harassment or discrimination.**  
...
5. **Raise a formal grievance in writing if the informal route is not protecting you.**  
...
6. **Ask for interim protections before the final outcome.**  
...
7. **Ask to be accompanied if a grievance meeting is arranged.**  
...
8. **Get one source of backup support today.**  
