...
tags:
  - "notice says no contact"
  - "official order no contact"
  - "communication restricted by order"
  - "restricted from contacting someone"
  - "served with no contact order"
  - "served with restraining order"
  - "served with non-molestation order"
  - "bail conditions no contact"
  - "protective order contact ban"
  - "court order says stay away"
  - "what do i do if i am served with a no contact order"
  - "what do i do if a notice says i cannot contact someone"
  - "what do i do if bail says no contact"
  - "what do i do if an order bans messages"
  - "help i received a restraining order"
  - "help i cannot contact someone"
  - "help i got bail conditions"
  - "help i got a no contact notice"
  - "my order says no contact"
  - "my bail says no contact"
  - "my notice says no messages"
  - "protected person contacted me first"
  - "confused about indirect contact"
  - "unsure what counts as contact"
  - "worried liking posts counts"
  - "worried third party message counts"
  - "accidental contact after order"
  - "social media contact ban"
  - "family court contact order"
  - "police bail contact ban"
  - "prisoner contact restriction"
  - "no contct order notice"
  - "restraning order notice"
  - "official communication restriction"
last_reviewed: "2026-07-17"
date_created: "2026-05-18"
---

# What to do if… you are served with a no-contact order or official communication restriction (UK)
