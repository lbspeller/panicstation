---
title: "What to do if… you receive calls from creditors or collectors shortly after a death"
jurisdiction: "UK"
category: "Death, bereavement & serious family crises"
tags:
  - creditor calls after death
  - debt collector calling after bereavement
  - calls about deceased person's debt
  - debt collection after someone dies
  - collector chasing family after death
  - executor getting debt calls
  - not the executor debt calls
  - probate debt demands
  - estate debt phone calls
  - bereavement debt harassment
  - unknown debts after death
  - pressure to pay deceased bills
  - debt letters and calls after funeral
  - dealing with creditors after death
  - who pays debts after death uk
  - collectors asking for payment now
  - creditors contacting next of kin
last_reviewed: "2026-02-23"
---

# What to do if… you receive calls from creditors or collectors shortly after a death (UK)
## Short answer
...
## What to do now
1. **End the call safely and set a boundary.** Say: “They have died. I can’t discuss this by phone. Please send everything in writing.” Then hang up.
2. **Write down a call log immediately.** Note date/time, company name, caller name, phone number, what they claimed, and what they asked you to do.
3. **Ask for written proof, not a conversation.** If you do speak again, ask for:
...
4. **Work out who is allowed to deal with the debt.**
   - If there’s a will, the **executor** usually handles creditor contact.
   - If there’s no will, an **administrator** is appointed (often after applying for letters of administration).
   If you’re not that person, keep it simple: “I’m not the personal representative. Please address correspondence to ‘The Estate of [Name]’ and I will pass it on.”
5. **Send a short “notification of death” message (when you can).** For each creditor/collector, send a brief letter/email: the person has died, and you want the claim confirmed in writing and contact paused while the estate is being sorted.
...
6. **Protect yourself from being pushed into personal liability.**
...
7. **If the contact becomes aggressive or excessive, escalate in writing.**
