...
tags:
  ...
  - plug sparks when inserting
  - socket flashes when plugging in
  - blue spark from socket
  - sparks from wall socket
  - arcing at socket when plugging in
  - outlet crackles when plugging in
  - outlet pops when plugging in
  - plug and socket flash
  - sparking outlet in kitchen
  - sparking extension lead connection
  - socket smells hot when plugging in
  - socket feels warm after spark
  - scorch marks around socket
  - plug trips power when inserted
...
# What to do if… an outlet sparks or flashes when you plug something in (UK)
...
- https://firekills.campaign.gov.uk/prevention/
