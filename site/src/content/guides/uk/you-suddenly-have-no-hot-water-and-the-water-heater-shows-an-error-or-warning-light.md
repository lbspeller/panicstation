...
tags:
  ...
  - home hot water emergency
last_reviewed: "2026-03-04"
---

# What to do if… you suddenly have no hot water and the water heater shows an error or warning light (UK)
...
## What to do now
1. **Check for immediate danger signs (30 seconds).**
...
2. **Pause use and make the area safe.**
...
3. **Capture the information you’ll need (prevents missteps).**
...
4. **Do only external supply checks (no tools, no covers).**
...
6. **If you try a reset, keep it to one attempt.**
