...
tags:
  - "official notice no contact"
  - "no contact notice childcare"
  - "must not contact someone"
  - "share childcare no contact"
  - "child handover no contact"
  - "co-parent no contact order"
  - "practical responsibilities no contact"
  - "court order no contact children"
  - "police bail no contact childcare"
  - "restraining order with children"
  - "what do i do if no contact"
  - "what do i do if childcare blocked"
  - "what do i do if child handover"
  - "what do i do if notice unclear"
  - "help i cannot message co-parent"
  - "help i have no contact notice"
  - "help i share childcare"
  - "help i might breach conditions"
  - "my child handover is unclear"
  - "my no contact terms are unclear"
  - "direct contact banned"
  - "indirect contact banned"
  - "stay away from school"
  - "school pickup order confusion"
  - "child medication handover problem"
  - "official notice wording confusion"
  - "accidental breach risk"
  - "child arrangements order confusion"
  - "bail conditions confusion"
  - "non molestation order confusion"
...
# What to do if… you receive a no-contact order but share childcare or other responsibilities (UK)
...
## What to do now
1. **Read the full notice before doing anything else.**  
...
2. **Identify exactly what kind of notice it is.**  
...
3. **Check whether childcare is mentioned at all.**  
...
4. **Pause any handover that would put you in contact or near a banned place.**  
...
5. **Use a no-direct-contact childcare plan only if it fits the written terms.**  
   Safer options may include:
   - a solicitor sending essential child-focused information;
...
6. **Handle children’s items without creating contact.**  
...
7. **Ask for written clarification or variation using the official route on the document.**  
...
8. **If there is an immediate child safety emergency, contact emergency services instead of the protected person.**  
...
9. **Keep a simple compliance record.**  
...
- https://www.mygov.scot/legal-protection-against-abuse-and-harassment/non-harassment-order
- https://www.justice-ni.gov.uk/articles/applying-non-molestation-occupation-order
