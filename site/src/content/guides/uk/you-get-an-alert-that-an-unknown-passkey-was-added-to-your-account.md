...
tags:
  ...
  - "unexpected passkey added"
  - "unknown passkey added"
  - "unrecognised passkey alert"
  - "account passkey changed"
  - "new sign-in method"
  - "passwordless sign-in alert"
  - "account security alert"
  - "what do i do if a passkey was added"
  - "what do i do if my account has a new passkey"
  - "what do i do if i got a passkey alert"
  - "what do i do if sign-in method changed"
  - "help i got a passkey notification"
  - "help i did not add this passkey"
  - "my account has an unknown passkey"
  - "my email says passkey added"
  - "passkey i didnt add"
  - "passkee added alert"
  - "paskey added alert"
  - "cannot recognise passkey"
  - "new device in account"
  - "security settings changed"
  - "login method changed"
  - "sessions i do not recognise"
  - "recovery email changed"
  - "email forwarding appeared"
  - "is a passkey a password"
  - "passkey means hacked"
...
# What to do if… you get an alert that an unknown passkey was added to your account (UK)
...
## What to do now
1. **Open the account without using the alert link.**  
...
2. **Remove any passkey you do not recognise.**  
...
4. **Secure the email account linked to this account.**  
...
5. **Change the password if the account still uses one.**  
...
6. **Check for other hidden access.**  
...
8. **If it is a work or school account, contact IT or security now.**  
...
9. **If the account can move money, reduce the risk immediately.**  
...
10. **Report fraud or cyber crime if money is missing, you are locked out, or there is ongoing unauthorised activity.**  
