...
tags:
  ...
  - "work account sent emails"
  - "work email account compromised"
  - "work inbox being used"
  - "hacked work email account"
  - "someone using my work account"
  - "unauthorised emails from work"
  - "what do i do if work emails sent"
  - "what do i do if my work account"
  - "what do i do if messages sent"
  - "what do i do if email compromised"
  - "help i found sent emails"
  - "help i think work email hacked"
  - "help i see messages not mine"
  - "help i clicked phishing at work"
  - "my work account sent emails"
  - "my sent items look wrong"
  - "unexpected sent items at work"
  - "strange messages from my account"
