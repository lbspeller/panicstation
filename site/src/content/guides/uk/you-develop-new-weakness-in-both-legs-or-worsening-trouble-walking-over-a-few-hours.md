...
tags:
  ...
  - trouble walking getting worse
  - worsening gait over hours
  ...
  - difficulty walking after illness
...
2. **Make yourself safer while help is on the way.**  
...
3. **Tell 999 right away if any of these are present (they change urgency and response):**
...
4. **Write down a quick timeline (or text it to someone).**  
   - When it started, when it clearly worsened, and what changed.  
   - This helps clinicians make time-critical decisions.
5. **Gather essentials for the ambulance/A&E (one small pile/bag):**  
...
6. **If you can, ask someone nearby to stay with you until the ambulance arrives.**  
