---
title: "What to do if… you find dampness spreading around a skirting board or baseboard with no obvious source"
jurisdiction: "UK"
category: "Home & property emergencies"
tags:
  - damp patch at skirting board
  - dampness spreading by baseboard
  - wet skirting board no leak
  - wall damp at floor line
  - mystery moisture by skirting
  - hidden leak in wall
  - leaking pipe under floor
  - damp patch getting bigger
  - musty smell near skirting
  - water stain at bottom of wall
  - unknown water source indoors
  - rising damp or leak unsure
  - condensation or leak confusion
  - damp after rain unsure source
  - damp behind furniture near wall
  - wet plaster near skirting
  - moisture in living room wall
  - damp in rented flat reporting
  - homeowner damp emergency steps
last_reviewed: "2026-03-04"
---

# What to do if… you find dampness spreading around a skirting board or baseboard with no obvious source (UK)
## Short answer
...
## What to do now
1. **Make a safer pause and protect electrics first.**
...
2. **Do a quick “active leak” check (minutes).**
...
3. **Shut off water to limit damage if it’s clearly spreading or the meter suggests a leak.**
...
4. **Check the most likely “hidden” sources right around that wall section.**
...
5. **Control spread while you arrange help.**
...
6. **Contact the right party today.**
...
7. **Document clearly (helps repairs, disputes, and insurance).**
