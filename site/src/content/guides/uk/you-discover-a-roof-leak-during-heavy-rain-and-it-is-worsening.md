...
tags:
  ...
  - bucket under ceiling leak
  - protect electrics from leak
  - water near light fitting
  - wet ceiling collapse risk
  - ceiling bulging from water
  - attic loft leak during rain
  - landlord roof leak emergency
  - emergency repairs roof leak
  - temporary leak containment
  - leaking roof at night
  - damp patch spreading fast
  - who to call for roof leak
...
## What to do now
1. **Move people and pets out of the affected room.** If the ceiling is sagging/bulging or plaster is falling, close the door and keep everyone out.
2. **Isolate electricity safely (only if you can do it without risk).**
...
3. **Contain the water (without taking risks).**
...
6. **Document quickly (30–60 seconds).** Take photos/video of the active leak, any ceiling bulge/sag, and any damaged items/floors (your phone will capture time/date).
