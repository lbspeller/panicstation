---
title: "What to do if… you are asked to coordinate a rapid handover from hospital to hospice and information is missing"
jurisdiction: "UK"
category: "Death, bereavement & serious family crises"
tags:
  - rapid hospital to hospice handover
  - discharge to hospice missing info
  - urgent hospice transfer
  - last minute hospice coordination
  - discharge paperwork missing
  - medication list missing
  - discharge summary not provided
  - dnacpr form missing
  - resuscitation status unclear
  - anticipatory medicines not arranged
  - just in case meds missing
  - syringe driver plan unclear
  - hospice admission today
  - end of life transfer
  - palliative care handover
  - out of hours plan missing
  - equipment not delivered
  - transport to hospice
  - carer asked to coordinate
  - hospital discharge confusion
last_reviewed: "2026-03-03"
---

# What to do if… you are asked to coordinate a rapid handover from hospital to hospice and information is missing (UK)
...
## What to do now
1. **Name the blocker clearly (one sentence) and ask for the discharge lead.**
...
2. **Ask for the “minimum safe handover set” in writing before the person leaves.**
   Request (as a single checklist) and do not leave without it:
...
3. **Get the ward pharmacist (or medicines team) involved immediately.**
...
4. **Call the hospice admissions/clinical team and do a “receipt test”.**
...
5. **Confirm equipment and transport are actually booked (not “requested”).**
...
6. **Lock in an out-of-hours plan before the hospital door closes.**
...
7. **Escalate quickly if you’re being pressured to proceed without safety basics.**
