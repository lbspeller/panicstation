...
tags:
  ...
  - "screen moving by itself"
  - "phantom mouse movement"
  - "laptop hacked panic"
  - "pc hacked panic"
  - "computer hacked panic"
  - "what do i do if cursor moves"
  - "what do i do if mouse moves"
  - "what do i do if computer hacked"
  - "what do i do if remote access"
  - "help i think computer hacked"
  - "help i see cursor moving"
  - "help i installed anydesk"
  - "help i installed teamviewer"
  - "my cursor is moving"
  - "my computer is being controlled"
  - "my laptop is acting strange"
  - "my mouse is moving"
  - "windows opening by themselves"
  - "cursor clicking without me"
  - "unknown app on computer"
  - "remote access pop up"
  - "passwords may be exposed"
  - "teamviewer scam worry"
  - "anydesk scam worry"
  - "tech support scam worry"
  - "faulty mouse or hacked"
...
# What to do if… you suspect someone has remote access to your computer because the cursor is moving on its own (UK)
