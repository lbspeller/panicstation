...
tags:
  ...
  - "what do i do if data breached"
  - "what do i do if password reused"
  - "what do i do if password leaked"
  - "what do i do if credentials compromised"
  - "help i reused my password"
  - "help i got breach email"
  - "help i used same password"
  - "help i think my password leaked"
  - "my password was in a breach"
  - "my reused password is compromised"
  - "unexpected login alert"
  - "password reset emails"
  - "strange account activity"
  - "new device login"
  - "email forwarding rules"
  - "unknown account sessions"
  - "phishing after breach"
  - "fake breach notice"
  - "scam breach email"
  - "data leak warning"
  - "account hacked or breached"
  - "banking password reused"
  - "email password reused"
...
# What to do if… you get notified of a data breach and you reuse that password on other accounts (UK)
...
## What to do now
1. **Make a quick list of where you used that password.**  
...
3. **Change the breached account password next.**  
...
4. **Change the reused password on other high-risk accounts.**  
   Do these before lower-risk accounts:
   - bank, credit card, PayPal, and other payment accounts
...
5. **Turn on two-step verification on the accounts that matter most.**  
...
6. **Set alerts where they are easy to switch on.**  
...
7. **Watch for signs that someone has tried to use the password.**  
...
8. **If personal details were exposed too, consider identity-fraud precautions.**  
...
9. **If the organisation mishandled your personal information, use the ICO route later.**  
