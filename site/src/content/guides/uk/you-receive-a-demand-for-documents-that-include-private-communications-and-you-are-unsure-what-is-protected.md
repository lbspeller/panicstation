...
tags:
  - "document demand private communications"
  - "private communications demanded"
  - "documents include private messages"
  - "asked to provide private documents"
  - "private chats requested"
  - "emails and messages demanded"
  - "unsure what documents protected"
  - "unsure what communications protected"
  - "what do i do if documents are demanded"
  - "what do i do if chats are requested"
  - "what do i do if emails are demanded"
  - "what do i do if messages are private"
  - "help i received a document demand"
  - "help i am being asked for chats"
  - "my private communications are requested"
  - "my documents include solicitor emails"
  - "my phone messages are demanded"
  - "my work messages are requested"
  - "solicitor emails in document demand"
  - "lawyer messages in private documents"
  - "whatsapp messages disclosure demand"
  - "social media messages requested"
  - "private emails in legal request"
  - "third party messages requested"
  - "court order document confusion"
  - "production order confusion"
  - "informal request or court order"
  - "legal privilege confusion"
  - "confidentiality or privilege confusion"
  - "privilage confusion"
  - "private comunications demanded"
  - "urgent deadline document demand"
  - "work account messages demanded"
  - "prison communications requested"
last_reviewed: "2026-07-17"
date_created: "2026-05-17"
---

# What to do if… you receive a demand for documents that include private communications and you are unsure what is protected (UK)
...
## What to do now
1. **Read the first page slowly and identify what it is.**  
...
2. **Check which legal system or authority it refers to.**  
...
3. **Preserve things without changing them.**  
...
4. **Put the requested material into rough categories before sharing it.**  
   Make a private list for your adviser, not for the requester, covering:
   - messages or emails with a solicitor, barrister, legal adviser, or their office,
...
5. **If it is not clearly a court order or formal notice, ask for the written basis.**  
...
6. **If it is clearly a court order, production order, notice, or strict deadline, treat it as urgent.**  
...
7. **Handle legal advice communications as potentially privileged until checked.**  
...
8. **Do not create a large export unless it is safe to do so.**  
...
9. **If the demand involves work systems, tell the right person only.**  
...
10. **If you are in prison, on probation, or the demand concerns prison communications, ask for the formal route.**  
...
- https://www.lawsociety.org.uk/topics/dispute-resolution/legal-professional-privilege-guide
...
- https://prisonersadvice.org.uk/wordpress/
