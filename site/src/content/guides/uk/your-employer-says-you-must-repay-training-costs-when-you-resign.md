...
tags:
  ...
  - "training costs deducted final pay"
  - "mandatory training repayment demand"
  - "training clawback at work"
  - "training bond repayment"
  - "leaving job training payback"
  - "certification costs after leaving"
  - "what do i do if employer wants training costs"
  - "what do i do if training costs are deducted"
  - "what do i do if i owe training fees"
  - "what do i do if training repayment demanded"
  - "help i am being charged training costs"
  - "help i cannot afford training repayment"
  - "help i was invoiced for training"
  - "help i left job owing training fees"
  - "my employer deducted training costs"
  - "my final pay has training deduction"
  - "my contract has training clawback"
  - "my employer sent training invoice"
  - "final pay lower than expected"
  - "payslip shows training deduction"
  - "unexpected money taken from wages"
  - "invoice after leaving job"
  - "threatened deductions from wages"
  - "training payback confusion"
  - "training bond confusion"
  - "clawback clause confusion"
...
# What to do if… your employer says you must repay training costs when you resign (UK)
...
- https://www.nidirect.gov.uk/articles/being-paid-and-payslips
