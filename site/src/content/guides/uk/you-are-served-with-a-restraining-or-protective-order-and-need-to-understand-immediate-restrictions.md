...
tags:
  ...
  - "served with non-molestation order"
  - "served with occupation order"
  - "served with dvpo"
  - "served with dvpn"
  - "served with dapo"
  - "served with dapn"
  - "served with stalking protection order"
  - "served with no contact order"
  - "restraining order immediate restrictions"
  - "protective order immediate restrictions"
  - "what do i do if served restraining order"
  - "what do i do if served protective order"
  - "what do i do if no contact order"
  - "what do i do if ordered to leave home"
  - "help i got restraining order papers"
  - "help i breached order by accident"
  - "help i cannot contact my ex"
  - "help i must leave home"
  - "my restraining order papers arrived"
  - "my protective order says no contact"
  - "afraid of accidental breach"
  - "cannot text to apologise"
  - "cannot go near address"
  - "order says direct indirect contact"
  - "court papers say penal notice"
  - "confused by protective order"
  - "confused by no contact order"
  - "restraining order or injunction"
  - "restaining order served"
  - "protectve order served"
  - "shared home protective order"
...
# What to do if… you are served with a restraining or protective order and need to understand immediate restrictions (UK)
...
## What to do now
1. **Get to a quiet safe pause before reading.**  
...
2. **Read the order slowly with a pen.**  
...
3. **Treat “no contact” as direct and indirect unless the order clearly says otherwise.**  
...
4. **Map the places you must avoid.**  
...
5. **If the order affects your home, take essentials only.**  
...
6. **Identify the type of order from the paperwork.**  
...
7. **Start a factual compliance log today.**  
...
8. **Contact the court or police only for logistics, not interpretation.**  
...
9. **Get legal advice quickly and keep the question narrow.**  
...
- https://www.gov.uk/government/collections/family-law-forms
...
- https://www.judiciary.uk/wp-content/uploads/2025/12/PFDs-Guidance-2026-Non-Molestation-Orders-under-the-Family-Law-Act-1996.pdf
