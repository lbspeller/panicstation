...
tags:
  ...
  - "relative may be transferred"
  - "relative moved hospital quickly"
  - "ill relative hospital transfer"
  - "urgent hospital transfer decision"
  - "hospital moving my relative"
  - "relative transfer to another hospital"
  - "critically ill relative moved"
  - "what do i do if relative transferred"
  - "what do i do if hospital calls"
  - "what do i do if transfer urgent"
  - "what do i do if relative moved"
  - "help i got hospital transfer call"
  - "help i must answer quickly"
  - "help i cannot reach doctor"
  - "help i feel pressured by hospital"
  - "my relative is critically ill"
  - "my relative may be moved"
  - "my family member is in icu"
  - "my relative transfer decision"
  - "rushed hospital phone call"
  - "unclear receiving hospital"
  - "no ward details yet"
  - "consultant not available"
  - "transfer due to no beds"
  - "specialist centre transfer"
  - "capacity transfer confusion"
  - "next of kin confusion"
  - "consent to transfer confusion"
...
# What to do if… you are told a critically ill relative must be transferred to another hospital quickly (UK)
...
3. **Ask what you are being asked to do.** Say: “Are you asking for a decision from the patient or a legal decision-maker, or are you informing us about a clinical transfer decision?”
...
4. **State any legal authority or known wishes clearly.**
...
5. **Ask the transfer safety questions.**
...
6. **Get the receiving contact details before the transfer.** Ask for the receiving unit’s phone number, the hospital switchboard route if a direct number is not available, and when the first update after arrival is expected.

7. **Use the hospital escalation route if communication is breaking down.** In England, ask for PALS if it is available at that time. Elsewhere in the UK, ask for the hospital’s patient advice, liaison, complaints, or feedback service. If it is out of hours, ask for the on-call site manager, duty manager, or senior nurse and request a clear call-back time.

8. **Protect practical essentials.** Ask what will happen to personal belongings, medication, phone, glasses, hearing aids, dentures, or mobility aids. Keep any useful identifier to hand, such as the NHS or hospital number, CHI number in Scotland, or any local hospital identifier if known.

9. **Keep one calm channel.** Choose one person to speak to staff and one person to update family. If you are not the main caller, help with transport, childcare, chargers, food, or writing notes.

10. **Correct contact mistakes quickly.** If staff are consulting the wrong person, say plainly who the correct contact, attorney, guardian, or known decision-maker is and how to reach them now.
...
- https://www.nhsinform.scot/care-support-and-rights/health-rights/communication-and-consent/information-for-carers-using-nhs-services/
