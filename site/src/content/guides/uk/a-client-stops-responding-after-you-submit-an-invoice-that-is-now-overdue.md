...
tags:
  ...
  - "client ignoring overdue invoice"
  - "client silent after invoice"
  - "overdue invoice no reply"
  - "unpaid invoice no response"
  ...
  - "what do i do if client will not pay"
  - "help i sent an invoice no reply"
  - "help i have an overdue invoice"
  - "help i am being ignored by a client"
  - "help i might not get paid"
  - "my client has gone silent"
  - "my invoice is overdue"
  - "my freelance invoice is unpaid"
  - "my contractor invoice is overdue"
  - "no reply to invoice"
  - "payment overdue after service"
  - "invoice reminder ignored"
  - "client missed payment deadline"
  - "admin delay or unpaid invoice"
  - "invoice dispute or late payment"
  - "ghosted after sending invoice"
  - "chasing payment without reply"
...
# What to do if… a client stops responding after you submit an invoice that is now overdue (UK)
...
- https://www.scotcourts.gov.uk/taking-action/simple-procedure/how-to-make-a-claim-with-simple-procedure/
- https://www.justice-ni.gov.uk/articles/small-claims
