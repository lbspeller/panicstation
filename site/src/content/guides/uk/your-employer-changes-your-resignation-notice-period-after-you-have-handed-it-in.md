...
tags:
  ...
  - "notice period changed after resigning"
  - "employer changed my notice period"
  - "last working day changed"
  - "resignation end date dispute"
  - "employer says notice is longer"
  - "employer says notice is shorter"
  - "notice period suddenly changed"
  - "resignation date disagreement"
  - "notice period after resignation"
  - "what do i do if my notice changed"
  - "what do i do if hr changed my notice"
  - "what do i do if my last day changed"
  - "what do i do if employer extends notice"
  - "help i resigned and notice changed"
  - "help i am being told to work longer"
  - "my employer changed my resignation date"
  - "my last day is disputed"
  - "my notice period seems wrong"
  - "my resignation notice is being questioned"
  - "contract says different notice"
  - "hr says resignation date wrong"
  - "manager says notice period wrong"
  - "new notice period letter"
  - "asked to sign new notice"
  - "garden leave after resigning"
  - "payment in lieu confusion"
  - "pilon after resignation"
  - "notice peroid changed"
...
# What to do if… your employer changes your resignation notice period after you have handed it in (UK)
...
## What to do now
1. **Find the rule they say applies.**  
   Pull up your employment contract, written statement of employment particulars, staff handbook notice section, and any collective agreement if you are covered by one. Look for:
...
2. **Check whether this is a correction or a new change.**  
...
3. **Write down the key dates before replying.**  
   Record:
   - when you submitted your resignation, including date, time, and method
...
4. **Ask for their position in writing.**  
...
6. **If the correct notice is longer than you gave, ask for an agreed early release.**  
   Ask whether they will agree to waive part of the notice or release you early. If they agree, get written confirmation of:
   - the final date of employment
   - pay and benefits up to that date
   - handover expectations
   - return of equipment

7. **If they want you to leave earlier, ask what mechanism they are using.**  
   Ask them to confirm in writing whether this is:
   - **garden leave**, where you remain employed and paid but are told not to work
...
8. **Protect your final pay and documents.**  
   Ask HR to confirm:
   - what happens to accrued but unused holiday
...
9. **Keep a clean evidence file without breaching policy.**  
