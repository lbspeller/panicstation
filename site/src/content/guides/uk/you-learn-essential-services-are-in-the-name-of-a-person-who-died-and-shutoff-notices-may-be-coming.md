...
tags:
  ...
  - shutoff notice worry
  - gas electric in dead persons name
  - water bill deceased account
  - broadband account holder died
  - transfer utility account uk
  - bereavement utility team
  - change of tenancy utilities
  - keep lights and heat on
  - direct debit stopped after death
  - executor paying utility bills
  - property occupied after death
  - empty house utilities after death
  - urgent utility account change
  - avoid disconnection
  - meter reading after death
  - proof of death for utilities
  - priority services register help
last_reviewed: "2026-03-03"
---

# What to do if… you learn essential services are in the name of a person who died and shutoff notices may be coming (UK)
...
## What to do now
1. **Make a 10-minute “services list” (one page).**  
...
2. **Take proof-of-state photos right now.**  
...
3. **Call each supplier’s bereavement team or customer service and use a simple script.**  
   Say:  
   ...
   Ask for:  
   - the **exact process name** they use (often “bereavement” or “change of tenancy”)  
...
4. **If you are not the legal decision-maker, still do the “stop shutoff” call.**  
...
5. **If you live at the address, ask to be treated as the responsible occupier immediately.**  
...
6. **If the property is empty, tell them that clearly and ask how they handle “vacant property” supply.**  
...
7. **If anyone in the home is vulnerable, request extra support now (not later).**  
...
8. **If you’re getting nowhere, escalate fast but calmly.**  
