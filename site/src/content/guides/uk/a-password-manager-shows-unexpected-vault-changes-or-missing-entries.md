...
tags:
  ...
  - "password vault changed"
  - "vault items missing"
  - "missing passwords in vault"
  - "passwords disappeared from vault"
  ...
  - "what do i do if vault items missing"
  - "what do i do if passwords disappeared"
  - "what do i do if shared vault changed"
  - "help i lost saved passwords"
  - "help i see vault changes"
  - "help i cannot find passwords"
  - "help i think vault hacked"
  - "my password manager changed"
  - "my vault entries disappeared"
  - "my password vault is missing entries"
  - "my saved passwords are gone"
  - "unknown device signed in"
  - "new logins appeared"
  - "vault emptied suddenly"
  - "deleted items in password manager"
  - "lost 2fa codes in vault"
  - "vault history looks wrong"
  - "password manager hacked"
  - "master password compromised"
  - "sync conflict or hack"
  - "vault rollback confusion"
  - "passwords missing after update"
...
## What to do now
1. **Freeze the vault state as much as you can.**  
...
3. **Refresh recovery codes only after access is secure.**  
...
4. **Make a quick record before trying recovery.**  
...
5. **Check built-in recovery inside the password manager.**  
...
6. **Secure the email account used for the password manager.**  
...
7. **Check the device you are using before broad password resets.**  
...
8. **Protect the highest-impact accounts first.**  
...
9. **Ask the password-manager vendor for account and vault help.**  
...
10. **Report fraud or cyber crime only if there has been fraud, money loss, or a crime.**  
