...
tags:
  ...
  - "employer cannot meet payroll"
  - "company cannot pay wages"
  - "workplace pay uncertainty"
  - "employer cash flow crisis"
  - "business may be insolvent"
  - "wages at risk"
  - "what do i do if payroll fails"
  - "what do i do if wages are late"
  - "what do i do if salary is delayed"
  - "what do i do if employer cannot pay"
  - "help i may not get paid"
  - "help i might miss payday"
  - "help i was warned about payroll"
  - "help i need my wages"
  - "my employer may not pay"
  - "my salary might not arrive"
  - "my wages are at risk"
  - "payday is uncertain"
  - "pay warning from employer"
  - "late wage warning"
  - "missing payslip access"
  - "no written payroll update"
  - "partial pay mentioned"
  - "deferred pay request"
  - "reduced pay request"
  - "company money trouble"
  - "employer going bust"
  - "wagez may be late"
  - "payrol may fail"
...
# What to do if… your employer warns you that they may not be able to pay your wages (UK)
...
## What to do now
1. **Ask for the key facts in writing.** Email payroll, HR, or your manager and ask:
...
2. **Save your pay evidence outside work systems.** Download or copy:
...
3. **Check what you should be paid.** Write down the pay period, your usual pay date, your gross pay, expected net pay, and any overtime, commission, bonus, holiday pay, or expenses due. Keep this simple; exact legal calculations can wait.

4. **If you are asked to accept delayed or reduced pay, slow it down.** Ask for a written document stating:
