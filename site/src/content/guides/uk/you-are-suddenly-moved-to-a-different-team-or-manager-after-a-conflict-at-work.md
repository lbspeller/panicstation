...
tags:
  ...
  - "different manager after conflict"
  - "moved teams after argument"
  - "reassigned after workplace complaint"
  - "transferred after work conflict"
  - "changed team after disagreement"
  - "new manager after grievance"
  - "work transfer feels punitive"
  - "manager changed after complaint"
  - "moved department after conflict"
  - "what do i do if moved teams"
  - "what do i do if transferred"
  - "what do i do if manager changed"
  - "what do i do if reassigned"
  - "help i was moved teams"
  - "help i got transferred suddenly"
  - "help i have a new manager"
  - "help i fear work retaliation"
  - "my team changed after conflict"
  - "my manager changed after conflict"
  - "reporting line changed suddenly"
  - "duties changed after argument"
  - "access removed after conflict"
  - "excluded from meetings after complaint"
  - "pay hours location changed"
  - "handover demanded after conflict"
  - "retaliation or normal redeployment"
  - "grievance or disciplinary confusion"
  - "punishment or separation measure"
...
# What to do if… you are suddenly moved to a different team or manager after a conflict at work (UK)
