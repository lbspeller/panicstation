---
title: "What to do if… you discover a vehicle or storage unit linked to a person who died may be towed or cleared soon"
jurisdiction: "UK"
category: "Death, bereavement & serious family crises"
tags:
  - deceased person's car
  - car may be towed
  - vehicle about to be removed
  - vehicle removal threat
  - impound risk after death
  - storage unit after a death
  - storage unit clearing deadline
  - auction notice storage unit
  - bereavement urgent property
  - executor urgent tasks
  - estate belongings at risk
  - v5c missing after death
  - logbook not found
  - sorn after death
  - dvla bereavement vehicle
  - car left on private land
  - council removal notice
  - time-critical estate assets
  - next of kin access problems
  - probate not started yet
last_reviewed: "2026-03-03"
---

# What to do if… you discover a vehicle or storage unit linked to a person who died may be towed or cleared soon (UK)
...
## What to do now
1. **Work out what kind of “removal” this is (takes 2 minutes, reduces panic).**
...
2. **Call the decision-maker and ask for a hold today.**
   ...
   - Storage: the facility manager/account team.
   Ask for: (a) the **deadline**, (b) what action stops removal/sale, and (c) an **email confirming a temporary hold/extension**.

3. **Get the minimum “proof pack” ready (send by email if possible).**
   - Your ID.
...
4. **Vehicle: ask exactly where it can go and who can release it (don’t guess).**
...
5. **Storage unit: get the facility’s process in writing.**
   Ask them to email:
...
6. **If you can access the vehicle/unit, retrieve only the irreplaceables first.**
   Prioritise: ID documents, keys, wills/paperwork, insurance/bank letters, devices (phones/laptops), photos/sentimental items, and anything needed to prove ownership/authority.
...
7. **Start the DVLA bereavement step that prevents admin spirals later (you can do this while the hold is in place).**
