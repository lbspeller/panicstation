...
tags:
  ...
  - "what do i do if a login page was fake"
  - "what do i do if i used a phishing page"
  ...
  - "my login details were stolen"
  - "my email password was exposed"
  - "suspicious url sign in"
  - "unexpected password reset email"
  - "new device login alert"
  - "unknown recovery details changed"
  - "strange email forwarding rule"
  - "fake website or real website"
  - "phising website"
  - "phishng link login"
  - "bank password entered"
  - "email account password reused"
...
12. **If you entered bank or card details, or money has left your account, contact your bank or card provider immediately.** Use the number on the back of your card, the official app, the official website, or 159 where appropriate. If you are in England, Wales or Northern Ireland, use Report Fraud. If you are in Scotland, report fraud to Police Scotland on 101, or call 999 in an emergency.
