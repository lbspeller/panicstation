...
tags:
  - "former employer contacting workplace"
  - "former employer contacting new job"
  - "old employer contacting workplace"
  - "old boss calling new job"
  - "ex employer contacting work"
  - "former employer spreading rumours"
  - "former employer badmouthing me"
  - "reference sabotage at new job"
  - "unexpected workplace reference contact"
  - "what do i do if old boss calls"
  - "what do i do if bad reference"
  - "what do i do if hr calls"
  - "what do i do if workplace gossip"
  - "help i got a bad reference"
  - "help i am being badmouthed"
  - "help i think old job lied"
  - "help i might lose my job"
  - "my former employer contacted hr"
  - "my old boss is calling"
  - "my new job got reference"
  - "new employer asking awkward questions"
  - "hr says old employer called"
  - "manager mentioned old reference"
  - "job offer feels at risk"
  - "probation feels suddenly unsafe"
  - "reference sounds informal"
  - "backchannel reference worry"
  - "unsolicited reference worry"
  - "employment gossip mistaken as reference"
  - "data shared without warning"
  - "rumours from old workplace"
  - "bad refrence from employer"
  - "ex emplyer contacting work"
...
# What to do if… a former employer is contacting your new workplace without warning (UK)
