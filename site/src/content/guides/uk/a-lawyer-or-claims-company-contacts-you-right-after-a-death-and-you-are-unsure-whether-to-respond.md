---
title: "What to do if… a lawyer or claims company contacts you right after a death and you are unsure whether to respond"
jurisdiction: "UK"
...
tags:
  ...
  - bereavement cold call
  - bereavement scam call
  - probate scam letter
  - inheritance scam message
  - unsolicited legal services
  - unsolicited claims offer
  - targeted marketing after bereavement
  - estate phone call unknown firm
  - grief brain decision freeze
  - unsure whether to reply
  - asked to sign quickly
  - asked for documents fast
  - funeral notice scam
  - unknown firm contacting family
  - sudden death admin pressure
last_reviewed: "2026-03-03"
---

# What to do if… a lawyer or claims company contacts you right after a death and you are unsure whether to respond (UK)
...
## What to do now
1. **Create a safe pause.** Say: “I can’t deal with this right now. Please email or post everything to me. I will respond after I’ve checked it.” Then end the call. (You don’t owe an explanation.)
2. **Write down exactly what happened.** Note the date/time, number/email, the name of the person, the firm name, what they said the matter is about, and what they asked you to do.
3. **Ask for a minimum written pack (only if you choose).** If you reply at all, ask for:
...
4. **Verify the firm independently (do not use their links).**
...
5. **Treat “official-sounding” claims as unproven until checked.** If they say they’re connected to “the court”, “probate”, “HMCTS”, “the FCA”, or “a regulator”, assume it could be impersonation until you verify through official channels you find yourself.
6. **If you feel pressured, use a one-sentence boundary.** “I’m not making decisions during bereavement. I will respond in writing after checks.” Repeat once, then stop responding.
7. **If you suspect a scam or you’ve already shared information, report it.**
...
8. **If it’s nuisance marketing (not an immediate fraud risk), reduce future contact.** Register with the **TPS** and report persistent nuisance calls/messages to the **ICO**. This won’t stop scammers, but it can reduce legitimate marketing and supports complaints.
9. **If it seems genuinely legal/probate-related but you’re unsure, route it through someone you trust.** Ask a calm friend/family member to read the message first, or ask a solicitor you choose (not the one contacting you) to sanity-check the approach.
