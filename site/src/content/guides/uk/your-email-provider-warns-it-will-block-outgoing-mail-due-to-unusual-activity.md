...
tags:
  - "email provider block warning"
  - "outgoing mail blocked"
  - "unusual activity email account"
  - "email account unusual activity"
  - "email sending suspended"
  - "email account sending spam"
  - "suspected hacked email account"
  - "email account takeover"
  - "smtp sending blocked"
  - "provider warns unusual activity"
  - "my email is sending spam"
  - "my email got blocked"
  - "my email is rate limited"
  - "my outgoing mail is blocked"
  - "help i got an email warning"
  - "help i cannot send email"
  - "help i think my email hacked"
  - "help i received security alert"
  - "what do i do if email blocked"
  - "what do i do if mail blocked"
  - "what do i do if unusual activity"
  - "what do i do if email hacked"
  - "forwarding rules changed"
  - "email filters i did not create"
  - "unexpected emails from me"
  - "new device sign-in alert"
  - "unknown mailbox forwarding"
...
# What to do if… your email provider warns it will block outgoing mail due to unusual activity (UK)
...
9. **If the warning email might be fake, report it without clicking it.**  
   Forward the suspicious email to report@phishing.gov.uk. Do not click links, open attachments, or reply to the message.
