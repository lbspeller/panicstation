---
title: "What to do if… you develop facial swelling from a tooth problem that seems to be spreading"
jurisdiction: "UK"
category: "Health & medical scares"
tags:
  - facial swelling tooth
  - swollen face toothache
  - dental infection spreading
  - tooth abscess swelling
  - jaw swelling tooth
  - cheek swelling tooth
  - gum swelling infection
  - swelling under jaw
  - neck swelling from tooth
...
# What to do if… you develop facial swelling from a tooth problem that seems to be spreading (UK)
...
## What to do now
1. **Decide emergency vs urgent dental care using these triggers (if in doubt, treat as emergency):**
...
2. **If you’re not in immediate danger, get urgent dental help today:**
...
4. **Get ready to describe what’s happening (this speeds urgent triage):**
...
5. **If symptoms escalate at any point (even while waiting):**
