...
tags:
  - "tax authority audit notice"
  - "audit notice deadline soon"
  - "tax audit letter arrived"
  - "tax enquiry deadline close"
  - "tax compliance check notice"
  - "tax records requested urgently"
  - "response deadline almost due"
  - "official tax letter worry"
  - "what do i do if audit notice arrives"
  - "what do i do if tax deadline is soon"
  - "what do i do if tax records are requested"
  - "what do i do if audit letter seems suspicious"
  - "help i got a tax audit notice"
  - "help i cannot meet tax deadline"
  - "help i do not understand audit notice"
  - "my tax letter deadline is tomorrow"
  - "my audit notice looks suspicious"
  - "my records are not ready"
  - "deadline date on tax notice"
  - "reference number on audit letter"
  - "missing tax records"
  - "unclear documents requested"
  - "letter says formal notice"
  - "suspicious qr code on letter"
  - "tax audit or scam"
  - "audit notice or enquiry"
  - "compliance check or investigation"
  - "unsure about original records"
  - "self assessment audit notice"
  - "business tax audit notice"
...
# What to do if… you receive a tax audit notice and the response deadline is soon (UK)
