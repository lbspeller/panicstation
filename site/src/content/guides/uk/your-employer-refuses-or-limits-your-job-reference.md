...
tags:
  - "reference refused by employer"
  - "limited reference from employer"
  - "factual reference only"
  - "basic work reference"
  - "employer will not give reference"
  - "hr reference only"
  - "dates and job title reference"
  - "bad work reference"
  - "unfair work reference"
  - "misleading work reference"
  - "what do i do if my reference is refused"
  - "what do i do if my employer refuses reference"
  - "what do i do if reference is limited"
  - "what do i do if reference is factual only"
  - "help i cannot get a reference"
  - "help i have no work reference"
  - "help i got a bad reference"
  - "help i might lose job offer"
  - "my employer only gives dates"
  - "my old employer refuses reference"
  - "new employer chasing reference"
  - "job offer depends on reference"
  - "worried about reference check"
  - "reference says dates only"
  - "reference delayed by hr"
  - "reference policy problem"
  - "bad referance worry"
  - "employer referrence refused"
  - "settlement agreement reference issue"
  - "regulated role reference"
  - "financial services reference problem"
...
# What to do if… your employer refuses or limits your job reference (UK)
