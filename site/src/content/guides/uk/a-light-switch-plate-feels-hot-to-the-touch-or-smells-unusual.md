---
title: "What to do if… a light switch plate feels hot to the touch or smells unusual"
jurisdiction: "UK"
category: "Home & property emergencies"
tags:
  - hot light switch plate
  - light switch feels warm
  - light switch smells odd
  - burning smell from switch
  - switch plate hot to touch
  - warm wall switch
  - hot switch cover
  - sizzling switch sound
  - buzzing light switch
  - flickering lights and hot switch
  - electrical burning plastic smell
  - loose wiring at switch
  - overheating light switch
  - switch smells like burning
  - warm switch after use
  - hot dimmer switch plate
  - switch plate getting hotter
  - smoke smell near switch
  - hot switch in older house
last_reviewed: "2026-03-04"
---

# What to do if… a light switch plate feels hot to the touch or smells unusual (UK)
...
2. **Check for immediate danger (10 seconds):**  
...
3. **If there’s no active fire: isolate the electricity (only if it’s safe).**  
...
4. **Keep people away from the switch and surrounding wall.** Don’t let anyone touch it “to see if it’s still hot”.
5. **If you left other circuits on:** only reduce load **if it’s clearly safe**.  
...
6. **Arrange urgent professional help.** Contact a **registered electrician** and tell them:  
   - the switch plate felt hot,  
   - there was an unusual/burning smell, and  
   - whether anything buzzed/crackled or any breaker tripped.
7. **If you rent or it’s shared housing:** report it to your **landlord/agent/building manager immediately** as an electrical safety repair. If you had to isolate the supply, say so.
