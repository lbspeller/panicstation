...
tags:
  ...
  - "security app turned off"
  - "virus protection disabled"
  - "malware protection stopped"
  - "device protection switched off"
  - "antivirus keeps disabling"
  - "what do i do if antivirus disabled"
  - "what do i do if security app disabled"
  - "what do i do if virus protection off"
  - "what do i do if protection switched off"
  - "help i antivirus turned off"
  - "help i security app disabled"
  - "my antivirus disabled itself"
  - "my security app changed"
  - "real-time protection off"
  - "tamper protection off"
  - "security alerts missing"
  - "unknown admin changes"
  - "unknown profile installed"
  - "antivirus app missing"
  - "hacked device worry"
  - "possible malware infection"
  - "ransomware early signs"
  - "security update problem"
  - "expired antivirus confusion"
  - "antivirus conflict confusion"
  - "work device security disabled"
  - "home laptop antivirus disabled"
