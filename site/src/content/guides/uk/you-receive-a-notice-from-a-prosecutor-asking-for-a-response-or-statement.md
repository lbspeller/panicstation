...
tags:
  - "prosecutor notice received"
  - "case referred to prosecutor"
  - "case sent to prosecutor"
  - "notice asking me to respond"
  - "prosecutor asked for response"
  - "prosecution decision pending"
  - "official notice about case"
  - "police case with prosecutor"
  - "charging decision notice"
  - "written response requested"
  - "what do i do if prosecutor contacts me"
  - "what do i do if case referred"
  - "what do i do if asked to respond"
  - "what do i do if police case sent"
  ...
  - "my police case was referred"
  - "worried about responding"
  - "scared to say wrong thing"
  - "unsure if notice is real"
  - "deadline in prosecutor letter"
  - "statement under caution confusion"
  - "voluntary interview confusion"
  - "witness or suspect confusion"
  - "prosecutor or police confusion"
  - "prosecutor notice uk"
  - "case referred in uk"
...
# What to do if… you receive a notice from a prosecutor asking for a response or statement (UK)
...
- https://www.copfs.gov.uk/contact/enquiry-point/
