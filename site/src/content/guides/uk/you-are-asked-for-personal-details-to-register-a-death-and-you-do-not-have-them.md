...
tags:
  ...
  - don’t know full name spelling
  - don’t know usual address
  - don’t know occupation details
  - don’t know maiden name
  - asked questions by registrar
  ...
  - informant details missing
  - sudden bereavement admin shock
  - registering death with unknowns
last_reviewed: "2026-02-23"
---

# What to do if… you are asked for personal details to register a death and you do not have them (UK)
...
## What to do now
1. **Make a “known / not known” list (1 page) before you speak to anyone.**  
   Write:
   - confirmed details (and where they came from), and  
   - missing/uncertain details you will not guess.

2. **Contact the local register office for the area where the death happened and say: “I’m registering a death but I’m missing some personal details.”**  
   Ask them:
   - which details they consider essential for the appointment,  
...
3. **Bring any documents you can find quickly (even if incomplete).**  
...
4. **Use only “safe sources” that are likely to be accurate (and quick).**  
   In the next 30–60 minutes, check:
   - the person’s wallet/purse, phone “Medical ID,” or a labeled paperwork folder at home  
...
5. **If you can’t register yet because official paperwork isn’t ready, focus on the release point.**  
   Sometimes the death must be reviewed or investigated before registration paperwork is issued, and this can delay what the register office can do. If you’re unsure where it’s up to, contact:
   - the hospital bereavement office / care home manager, and/or  
...
6. **At the appointment, use clear wording to avoid pressure.**  
...
7. **After registration, use the simplest official notification route available.**  
