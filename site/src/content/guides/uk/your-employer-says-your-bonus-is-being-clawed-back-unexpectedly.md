...
seo_title: "Employer says your bonus must be repaid"
jurisdiction: "UK"
category: "Work & employment crises"
tags:
  - "employer clawing back bonus"
  - "bonus clawback unexpected"
  - "bonus being clawed back"
  - "bonus repayment demand"
  - "asked to repay bonus"
  - "work bonus taken back"
  - "unexpected bonus deduction"
  - "bonus overpayment claim"
  - "bonus clawback at work"
  - "employer wants bonus back"
  - "what do i do if my bonus is clawed back"
  - "what do i do if employer wants bonus back"
  - "what do i do if bonus was overpaid"
  - "what do i do if payroll deducts bonus"
  - "help i owe a bonus"
  - "help i got a bonus clawback"
  - "help i am being asked to repay bonus"
  - "my employer wants my bonus back"
  - "my payslip shows bonus deduction"
  - "my retention bonus is being reclaimed"
  - "my sign-on bonus is being reclaimed"
  - "payslip shows bonus deduction"
  - "sudden payroll deduction"
  - "unexpected repayment letter"
  - "bonus amount looks wrong"
  - "pay packet lower than expected"
  - "employer says clawback clause"
  - "bonus clawbak"
  - "bonus claw back"
  - "bonus payback demand"
...
# What to do if… your employer says your bonus is being clawed back unexpectedly (UK)
...
## What to do now
1. **Get the claim in writing.** Ask HR or payroll for:
...
2. **Save the documents before replying in detail.** Keep copies of:
...
3. **Separate a payroll overpayment from a clawback condition.**
...
4. **Ask for any deduction to be paused or made manageable.** If the amount is large, or a deduction would leave you short for rent, food, bills, travel, childcare, or debt payments, tell payroll in writing and ask for a fair repayment plan while the dispute is checked.

5. **Check the timing and wording if this is linked to leaving or notice.** Look for terms such as:
...
6. **Send a short dispute email the same day if needed.** Keep it calm and specific, for example: “I dispute that I owe this amount as stated. Please provide the clause or policy, the calculation, and the payroll correction plan. Please pause any deduction while this is reviewed.”

7. **Ask payroll how tax and National Insurance will be handled.** Request written confirmation of:
...
8. **Use the employer’s formal process if you are not getting clarity.** If HR or payroll will not pause, explain, or correct the issue, raise it as a formal grievance or under your employer’s formal pay dispute process. Attach the payslip, bonus wording, calculation questions, and your request for a pause.

9. **If a deduction has already happened, act promptly.** Save the payslip showing the deduction, note the payment date, and contact Acas for guidance. For many employment tribunal claims, Acas early conciliation is needed first, and time limits are strict.
