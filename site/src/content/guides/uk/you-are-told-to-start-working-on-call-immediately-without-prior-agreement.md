...
tags:
  ...
  - "sudden on-call rota"
  - "on-call without agreement"
  - "standby duty sprung on me"
  - "rota changed without warning"
  - "new overnight call duty"
  - "what do i do if on-call starts tonight"
  - "what do i do if my rota changed"
  - "what do i do if standby is mandatory"
  - "what do i do if work changed hours"
  - "help i am forced on-call"
  - "help i got on-call tonight"
  - "my employer added on-call"
  - "my rota changed suddenly"
  - "no on-call pay confirmed"
  - "on-call response time unclear"
  - "expected to answer overnight"
  - "too tired for on-call"
  - "sleep disrupted by work calls"
  - "threatened for refusing on-call"
  - "oncall duty without notice"
  - "standby shift without pay"
  - "mandatory overtime confusion"
  - "zero hours rota confusion"
  - "contract change confusion"
  - "handbook versus contract"
  - "care worker on-call duty"
...
# What to do if… you are told to start working on-call immediately without prior agreement (UK)
