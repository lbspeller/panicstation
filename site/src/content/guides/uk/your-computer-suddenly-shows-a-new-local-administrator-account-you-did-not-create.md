...
tags:
  ...
  - "random admin login"
  - "windows admin account appeared"
  - "mac admin user appeared"
  - "linux sudo user appeared"
  - "computer shows extra user"
  - "account i did not create"
  - "administrator i did not add"
  - "what do i do if admin account appeared"
  - "what do i do if computer was hacked"
  - "what do i do if new user appeared"
  - "what do i do if unknown account exists"
  - "help i found a new admin"
  - "help i think my computer is hacked"
  - "help i see an extra user"
  - "help i did not create this account"
  - "my computer has a new administrator"
  - "my laptop shows unknown user"
  - "my login screen changed"
  - "new user on login screen"
  - "admin account added overnight"
  - "passwords may be exposed"
  - "banking used on hacked computer"
  - "email used on compromised computer"
  - "administrator rights changed"
  - "account keeps coming back"
  - "not sure if malware"
  - "not sure if work account"
  - "maybe windows update caused user"
...
3. **If it is work, school, or IT-managed, stop and escalate.**  
...
4. **From a different trusted device, secure your key accounts.**  
   Use your phone or another computer that you trust to:
...
5. **Check whether the account is real only if you can do this safely.**  
   If you can sign in with a known-good account you already trust, use the computer’s built-in user management screen to check whether:
...
6. **Scan using trusted tools only.**  
...
7. **Use the safer recovery path if the account looks unauthorised.**  
   If the account was truly unauthorised, keeps returning, your privileges changed, or a scan finds malware, a safer recovery path is usually:
   - back up only irreplaceable personal files, such as documents and photos
...
8. **If money was lost or you were scammed, report it and tell your bank.**  
