...
tags:
  ...
  - "payroll bank details email"
  - "change payroll bank details"
  - "payroll bank details scam"
  - "fake payroll change request"
  - "fake hr payroll email"
  - "salary bank details change"
  - "payroll diversion email"
  - "payroll phishing message"
  - "bank details change email"
  - "what do i do if payroll email looks fake"
  - "what do i do if salary details changed"
  - "what do i do if payroll asks for bank details"
  - "what do i do if hr email feels suspicious"
  - "help i clicked payroll email"
  - "help i shared payroll details"
  - "help i entered work password"
  - "help i changed salary bank account"
  - "my payroll email looks suspicious"
  - "my salary might go to wrong account"
  - "my bank details were changed"
  - "my payslip bank details look wrong"
  - "unexpected payroll link"
  - "urgent bank details request"
  - "sender address looks odd"
  - "payroll portal login request"
  - "password reset email payroll"
  - "payslip account mismatch"
...
# What to do if… you receive a suspicious email asking you to change your payroll or direct deposit bank details (UK)
...
## What to do now
1. **Stop and verify through a trusted route.**  
...
2. **Check your payroll or self-service account from the normal route.**  
...
3. **Ask payroll to protect your record.**  
...
4. **Report the email to IT or security immediately.**  
...
5. **If you clicked or typed credentials, treat the account as at risk.**  
...
6. **If your pay may have been diverted, contact payroll and your bank now.**  
...
7. **Report the suspicious email to the UK phishing reporting service.**  
   Forward the email to report@phishing.gov.uk. Do this before deleting it if you can.

8. **If you lost money, were hacked, or shared sensitive details, use the police reporting route for your nation.**  
