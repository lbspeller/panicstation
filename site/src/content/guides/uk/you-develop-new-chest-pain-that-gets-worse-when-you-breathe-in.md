...
tags:
  ...
  - "sharp chest pain breathing in"
  - "stabbing chest pain on inhale"
  - "new chest pain today"
  - "worse chest pain deep breath"
  - "chest pain with cough"
  - "one-sided chest pain breathing"
  - "chest pain after illness"
  - "what do i do if chest pain"
  - "what do i do if breathing hurts"
  - "what do i do if chest hurts"
  - "what do i do if inhaling hurts"
  - "help i have chest pain"
  - "help i feel breathless"
  - "help i have stabbing chest pain"
  - "help i cannot breathe normally"
  - "my chest hurts when breathing"
  - "my chest pain is getting worse"
  - "my chest hurts after coughing"
  - "my breathing feels hard"
  - "shortness of breath with chest pain"
  - "dizzy with chest pain"
  - "sweaty with chest pain"
  - "coughing blood with chest pain"
  - "fast heartbeat with chest pain"
  - "blue lips with chest pain"
  - "chest pain or anxiety"
  - "chest pain or stitch"
  - "chest pain or pulled muscle"
  - "chest pain or pleurisy"
  - "cheast pain when breathing"
  - "short of breth chest pain"
...
# What to do if… you develop new chest pain that gets worse when you breathe in (UK)
...
## What to do now
1. Stop what you are doing. Sit upright, or use the position that lets you breathe most comfortably.
2. Call 999 now, or go to A&E now, if any of these apply:
...
3. If you are not sure whether it is a 999 emergency, use NHS 111 where available, or contact your GP out-of-hours or local urgent care service today. Say: “I have new chest pain that gets worse when I breathe in.”
4. If you are told to go to A&E or urgent assessment, follow that advice. Take your usual medicines list if it is easy to grab, but do not delay getting help to find paperwork.
5. If you are alone and symptoms feel worrying, unlock the door, keep your phone with you, and sit where someone can find you. Put a 999 or urgent-care call on speaker if that helps.
6. Make a short note for the call or triage:
...
7. If you are waiting for advice and want simple pain relief, only take medicine you normally can take, and follow the label. Do not take extra medicine to mask symptoms or delay urgent care.
