...
tags:
  - landlord wants to enter now
  - landlord demands immediate access
  - landlord turning up unannounced
  - entry without permission landlord
  - landlord has keys and wants in
  - tenant died what can landlord do
  - after tenant death access dispute
  - unsure what to allow landlord
  - bereavement housing rights
  - protecting deceased belongings
  - executor not appointed yet
  - letters of administration waiting
  - probate pending tenancy
  - family member dealing with flat
  - landlord pressure after death
  - emergency access or not
  - harassment landlord entry
  - quiet enjoyment rights
  - inventory of belongings after death
  - keys and access after death
last_reviewed: "2026-03-03"
---

# What to do if… a landlord demands immediate access to a home after a tenant dies and you are unsure what to allow (UK)
