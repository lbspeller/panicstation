...
tags:
  ...
  - "locked out of valuables"
  - "unpaid storage fees"
  - "storage unit arrears"
  - "overdue storage rent"
  - "self storage lockout"
  - "safe deposit box lockout"
  - "safe custody box locked"
  - "valuables held for nonpayment"
  - "what do i do if storage locked me out"
  - "what do i do if valuables are locked away"
  - "what do i do if storage fees are unpaid"
  - "what do i do if bank box is locked"
  - "help i cannot access valuables"
  - "help i missed storage payments"
  - "help i got a storage notice"
  - "my storage unit is locked"
  - "my valuables are being held"
  - "my safe deposit box is locked"
  - "notice of sale from storage"
  - "notice of disposal from storage"
  - "final notice storage unit"
  - "storage company says it will sell"
  - "need id from storage"
  - "need medication from storage"
  - "keys stuck in storage"
  - "legal documents in storage"
  - "storage lien confusion"
  - "safe deposit box confusion"
  - "storage auction confusion"
  - "storage disposel notice"
  - "storage fee arreas"
  - "uk storage arrears"
  - "uk safe deposit box"
...
# What to do if… you are locked out of a storage unit or safe deposit box due to unpaid fees (UK)
...
2. **Find the account details and the latest notice.**
   Look for:
...
3. **Call the provider, then send the same questions in writing.**
   Ask:
...
4. **If essential items are inside, ask for a supervised essentials visit.**
   Be specific: “I need a short supervised visit to collect my ID, medication, keys, work equipment, or legal documents.” Ask what ID they need, who will supervise, what you may remove, and whether they will confirm the appointment in writing. They may refuse or set conditions, but making a clear written request can help.

5. **If a sale or disposal is mentioned, focus on pausing that first.**
   Ask for the exact amount and deadline that will pause or cancel the step under your contract or notice. If you pay, ask for a receipt and written confirmation that the sale or disposal step has been paused, cancelled, or reviewed.

6. **If the charges look wrong, dispute them in writing without losing the urgent point.**
   Send a short message asking for an itemised ledger showing rent, late fees, admin fees, payments, credits, and the current balance. If you decide to pay so you can regain access, write that you are paying to restore access while disputing the specific charges you list.
