...
tags:
  - "more than one will found"
  - "multiple wills found"
  - "conflicting wills found"
  - "two wills after death"
  - "old will new will"
  - "later will disputed"
  - "family disagree about will"
  - "will validity dispute"
  - "executor unsure which will"
  - "codicil found with will"
  - "what do i do if two wills exist"
  - "what do i do if wills conflict"
  - "what do i do if family disputes will"
  - "what do i do if executor is unsure"
  - "help i found two wills"
  - "help i found a codicil"
  - "help i think the will is invalid"
  - "help i found an unsigned will"
  - "my family is arguing about a will"
  - "my relative left two wills"
  - "original will missing"
  - "will pages unstapled"
  - "unsigned will found"
  - "unwitnessed will found"
  - "different dates on wills"
  - "codicil with different date"
  - "copy of will found"
  - "draft will found"
  - "mirror wills confusion"
  - "codicil confusion"
  - "wittnessed will dispute"
...
## What to do now
1. **Secure every original will and codicil.**  
...
5. **Secure estate property without treating it as yours.**  
...
6. **Work out which UK nation’s process is involved.**  
...
7. **England and Wales: consider a caveat if someone may apply for probate on a disputed will.**  
...
8. **Northern Ireland: use the Northern Ireland caveat route if a disputed probate application may be made.**  
   Northern Ireland has its own caveat process and form. Use the nidirect route, not the England and Wales form.

9. **Scotland: get Scotland-specific confirmation advice before trying to block anything.**  
...
10. **Contact the will-drafter or firm, if one is named.**  
...
11. **If probate or confirmation has already been issued, stop distributions and get dispute-aware legal help.**  
