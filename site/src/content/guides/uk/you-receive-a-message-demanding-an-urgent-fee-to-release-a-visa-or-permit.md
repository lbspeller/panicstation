...
tags:
  ...
  - "suspicious visa payment message"
  - "immigration fee message"
  - "visa phishing message"
  - "fake visa payment demand"
  - "document release fee demand"
  - "courier fee for visa"
  - "visa held fee demand"
  - "what do i do if visa fee message"
  - "what do i do if visa scam"
  - "what do i do if permit fee"
  - "what do i do if immigration message"
  - "help i got visa fee text"
  - "help i clicked visa link"
  - "help i paid visa fee"
  - "help i shared passport details"
  - "my visa message looks fake"
  - "my permit fee seems suspicious"
  - "urgent deadline visa threat"
  - "bank transfer visa demand"
  - "gift card visa demand"
  - "crypto visa demand"
  - "passport details requested"
  - "one-time passcode requested"
  - "fake border fee"
  - "fake courier fee"
  - "fake release fee"
  - "visa release text"
...
# What to do if… you receive a message demanding an urgent fee to release a visa or permit (UK)
