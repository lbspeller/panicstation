...
tags:
  ...
  - "council tax payment missing"
  - "council tax paid not applied"
  - "wrong council tax reference"
  - "council tax account unpaid"
  - "property tax notice uk"
  - "escrow payment not applied"
  - "what do i do if council tax says unpaid"
  - "what do i do if council tax payment missing"
  - "what do i do if escrow payment failed"
  - "what do i do if tax notice arrives"
  - "help i got council tax arrears"
  - "help i received a summons"
  - "my council tax payment vanished"
  - "my escrow payment was not applied"
  - "my council tax account is wrong"
  - "notice says unpaid tax"
  - "payment shows in bank"
  - "reference number wrong"
  - "third party payment missing"
  - "direct debit failed"
  - "summons date coming soon"
  - "enforcement agent letter"
  - "council tax delinquancy notice"
  - "council tax arreas letter"
  - "rates arrears notice"
  - "domestic rates unpaid"
  - "northern ireland rates arrears"
  - "mortgage company payment issue"
  - "payment service council tax issue"
last_reviewed: "2026-05-18"
date_created: "2026-05-18"
---

# What to do if… you receive a property tax delinquency notice because your escrow payments were not applied (UK)
